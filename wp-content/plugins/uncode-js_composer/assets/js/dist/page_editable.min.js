        ...
        v.sortable({
            ...
            o = p(".vc_element-container:not(.vc_section, .vc_grid_container, .vc_flexbox_container)").sortable({
                ...
                over: function(e, t) {
                    ...
                    // END UNCODE EDIT
                    // START UNCODE EDIT - block vc_row/vc_row_inner from being dragged inside uncode_flexbox hierarchy
                ...
                stop: function(e, t) {
                    ...
                    var a = t.item.data("tag"),
                        ...
                        // END UNCODE EDIT	
                        r = !0;
                    // START UNCODE EDIT - block vc_row/vc_row_inner from being dropped inside uncode_flexbox hierarchy
                    if (a === 'vc_row_inner' || a === 'vc_row') {
