window.vc_iframe = {
    ...
    window.vc_iframe.showNoContent = function(e) {
        ...
        var c, s, d, l, t, a, o, i, n, r, _ = window.vc_iframe,
            v = (parent.vc.$page.addClass("vc-main-sortable-container"), p(parent.vc.$page));
        v.sortable({
            forcePlaceholderSize: !1,
            connectWith: !1,
            items: " > .wpb-content-wrapper > [data-tag=vc_row], > .wpb-content-wrapper > [data-tag=vc_section], > .wpb-content-wrapper > [data-tag=vc_grid_container], > .wpb-content-wrapper > [data-tag=vc_flexbox_container]",
            // START UNCODE EDIT	
            // handle: " > .vc_row .vc_move-vc_row, > .vc_controls .vc_element-move, > .vc_grid_container .vc_move-vc_grid_container, > .vc_flexbox_container .vc_move-vc_flexbox_container",
            ...
            helper: _.renderPlaceholder,
            tolerance: "pointer",
            start: function(e, t) {
                window.vc_iframe.startSorting(), t.placeholder.height(30), "vc_section" === t.item.data("tag") ? (i && i.sortable("destroy"), a && a.sortable("destroy"), o && o.sortable("destroy"), n && n.sortable("destroy"), r && r.sortable("destroy"), v.sortable("option", "connectWith", !1)) : v.sortable("option", "connectWith", ['[data-tag="vc_section"] > .vc_element-container']), v.sortable("refresh")
            },
            stop: function(e, t) {
                var a, o, i, n, r;
                // START UNCODE EDIT	
                // _.stopSorting(), "vc_section" === (a = t.item.data("tag")) && (c(), s(), d(), l()), v.sortable("option", "connectWith", !1), v.sortable("refresh"), o = window.parent.vc.map || !1, n = !0, (i = t.item.parents("[data-tag]:first").data("tag")) && (r = o[i].allowed_container_element || !0, window.parent.vc.checkRelevance(i, a) || (t.placeholder.removeClass("vc_hidden-placeholder"), p(this).sortable("cancel"), n = !1), o[a] === Object(o[a])) && ((!0 === o[a].is_container || !1 === o[a].is_container || "[object Boolean]" === toString.call(o[a].is_container)) && !0 === o[a].is_container || null != o[a].as_parent && "[object Array]" === Object.prototype.toString.call(o[a].as_parent) && 0 != o[a].as_parent) && !0 !== r && r !== a.replace(/_inner$/, "") && (t.placeholder.removeClass("vc_hidden-placeholder"), p(this).sortable("cancel"), n = !1), n && parent.vc.shortcodes.get(t.item.data("modelId")).view.parentChanged()
                _.stopSorting(), "vc_section" === (a = t.item.data("tag")) && (c(), s(), d(), l()), v.sortable("option", "connectWith", !1), v.sortable("refresh"), o = window.parent.vc.map || !1, n = !0, (i = t.item.parents("[data-tag]:first").data("tag")) && (r = o[i].allowed_container_element || !0, window.parent.vc.checkRelevance(i, a) || (t.placeholder.removeClass("vc_hidden-placeholder"), p(this).sortable("cancel"), n = !1), o[a] === Object(o[a])) && ((!0 === o[a].is_container || !1 === o[a].is_container || "[object Boolean]" === toString.call(o[a].is_container)) && !0 === o[a].is_container || null != o[a].as_parent && "[object Array]" === Object.prototype.toString.call(o[a].as_parent) && 0 != o[a].as_parent) && !0 !== r && (Array.isArray(r) ? !r.includes(a) && !r.includes(a.replace(/_inner$/, "")) : r !== a.replace(/_inner$/, "")) && (t.placeholder.removeClass("vc_hidden-placeholder"), p(this).sortable("cancel"), n = !1), n && parent.vc.shortcodes.get(t.item.data("modelId")).view.parentChanged()
                // END UNCODE EDIT	
            },
            update: function(e, t) {
                parent.vc.app.saveRowOrder(e, t), parent.vc.app.saveGridContainerOrder(e, t), parent.vc.app.saveFlexboxContainerOrder(e, t)
            }
        }), d = function() {
            o = p(".vc_element-container:not(.vc_section, .vc_grid_container, .vc_flexbox_container)").sortable({
                ...
                connectWith: ".vc_element-container:not(.vc_section, .vc_grid_container, .vc_flexbox_container)",
                items: "> [data-model-id]",
                cancel: ".vc-non-draggable",
                handle: ".vc_element-move",
                // START UNCODE EDIT	
                appendTo: document.body,	
                // start: _.startSorting,
                ...
                over: function(e, t) {
                    ...
                    }), a && o && (window.parent.vc.checkRelevance(i, a) || t.placeholder.addClass("vc_hidden-placeholder"), t.sender && (i = t.sender.closest(".vc_element").removeClass("vc_sorting-over")).find(".vc_element").length < 1 && i.addClass("vc_empty"), t.placeholder.closest(".vc_element").addClass("vc_sorting-over"), o[a] === Object(o[a])) && ((!0 === o[a].is_container || !1 === o[a].is_container || "[object Boolean]" === toString.call(o[a].is_container)) && !0 === o[a].is_container || null != o[a].as_parent && "[object Array]" === Object.prototype.toString.call(o[a].as_parent) && 0 != o[a].as_parent) && !0 !== n && (Array.isArray(n) ? !n.includes(a) && !n.includes(a.replace(/_inner$/, "")) : n !== a.replace(/_inner$/, "")) && t.placeholder.addClass("vc_hidden-placeholder")
                    if (a === 'vc_row_inner' || a === 'vc_row') {
                        if (t.placeholder.parents('[data-tag="uncode_flexbox"],[data-tag="uncode_flexbox_inner"]').length) {
                            t.placeholder.addClass("vc_hidden-placeholder");
                        }
                    }
                    // END UNCODE EDIT	
                },
                ...
                stop: function(e, t) {
                    ...
                    // START UNCODE EDIT	
                    if (a === 'vc_row_inner' || a === 'vc_row') {
                        if (t.item.parents('[data-tag="uncode_flexbox"],[data-tag="uncode_flexbox_inner"]').length) {
                    ...
                    window.parent.vc.checkRelevance(i, a) || (t.placeholder.removeClass("vc_hidden-placeholder"), p(this).sortable("cancel"), r = !1), o[a] === Object(o[a]) && ((!0 === o[a].is_container || !1 === o[a].is_container || "[object Boolean]" === toString.call(o[a].is_container)) && !0 === o[a].is_container || null != o[a].as_parent && "[object Array]" === Object.prototype.toString.call(o[a].as_parent) && 0 != o[a].as_parent) && !0 !== n && (Array.isArray(n) ? !n.includes(a) && !n.includes(a.replace(/_inner$/, "")) : n !== a.replace(/_inner$/, "")) && (t.placeholder.removeClass("vc_hidden-placeholder"), p(this).sortable("cancel"), r = !1), r && parent.vc.shortcodes.get(t.item.data("modelId")).view.parentChanged(), window.vc_iframe.stopSorting()
                    // END UNCODE EDIT	
                }
            })
        }, s = function() {
            ...
            n = p(".vc_grid_container").sortable({
                forcePlaceholderSize: !0,
                tolerance: "pointer",
                items: "> [data-tag=vc_grid_container_item]",
                handle: "> .vc_controls .vc_move-vc_column",
                cursor: "move",
                cursorAt: {
                    top: 20,
                ...
                update: parent.vc.app.saveContainerItemOrder
            })
        }, t = function() {
            r = p(".vc_flexbox_container").sortable({
                forcePlaceholderSize: !0,
                tolerance: "pointer",
                items: "> [data-tag=vc_flexbox_container_item]",
                handle: "> .vc_controls .vc_move-vc_column",
                cursor: "move",
                cursorAt: {
                    top: 20,
            ...
            i = p('[data-tag="vc_section"] > .vc_element-container').sortable({
                ...
                items: '[data-tag="vc_row"], [data-tag="vc_grid_container"], [data-tag="vc_flexbox_container"]',
                handle: "> .vc_row .vc_move-vc_row, > .vc_grid_container .vc_move-vc_grid_container, > .vc_flexbox_container .vc_move-vc_flexbox_container",
                cursor: "move",
                cursorAt: {
                    top: 20,
                    left: 16
        ...
        })(), d(), s(), l(), t(), v.disableSelection(), v.on("mouseenter", "select", function() {
            v.enableSelection()
        }), v.on("mouseleave", "select", function() {
            v.disableSelection()
        }), v.on("focus", 'input[type="text"],textarea', function() {
            v.enableSelection()
        }), v.on("blur", 'input[type="text"],textarea', function() {
            v.disableSelection()
        ...
        // START UNCODE EDIT	
        var $active_tab = p(e.context).find("[data-tab-id]:eq(" + t + ")").addClass('active'),	
            active_id = $active_tab.attr('data-tab-id'),	
            $active_panel = p(e.context).find("#" + active_id).addClass('active').addClass('in');	
        // END UNCODE EDIT	
        e.each(function() {
        ...
        e.hasClass("wpb_flexslider") ? (t = 1e3 * parseInt(e.attr("data-interval"), 10), a = e.attr("data-flex_fx"), o = !0, e.flexslider({
            ...
            sliderSpeed: 800,
            smoothHeight: !0
        }), e.addClass("loaded")) : e.hasClass("wpb_slider_nivo") ? (0 === (t = 1e3 * e.attr("data-interval")) && (t = 9999999999), jQuery.fn.nivoSlider && !e.data("nivo-initialized") && (e.data("nivo-initialized", !0), e.find(".nivoSlider").nivoSlider({
