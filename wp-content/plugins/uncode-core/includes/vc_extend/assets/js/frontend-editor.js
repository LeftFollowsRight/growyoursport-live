...
(a => {
    _.isUndefined(window.vc) && (window.vc = {}), a("body").on("keyup change input", "[data-vc-disable-empty]", function() {
        var d = a(this),
            i = a(d.data("vcDisableEmpty"));
        d.val().length ? i.prop("disabled", !1) : i.prop("disabled", !0)
    })
})(window.jQuery);
(n => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.showSpinner = function() {
        n("#vc_logo").addClass("vc_ui-wp-spinner")
    }, vc.hideSpinner = function() {
        n("#vc_logo").removeClass("vc_ui-wp-spinner")
    }, n(document).ajaxSend(function(n, i, e) {
        e && e.data && "string" == typeof e.data && e.data.match(/vc_inline=true/) && vc.showSpinner()
    }).ajaxStop(function() {
        vc.hideSpinner()
    })
})(window.jQuery);
(o => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.updateSettingsBadge = function() {
        o("a.vc_custom-code > .vc_custom-code-icon span.vc_badge").each(function() {
            var c = o(this);
            vc.isShowBadge() ? c.show() : c.hide()
        })
    }, vc.isShowBadge = function() {
        var o = !1;
        return ["css", "js_header", "js_footer"].forEach(function(c) {
            var c = "$custom_" + c;
            vc[c] && (c = vc[c].val()) && "" !== c.trim() && (o = !0)
        }), o
    }
})(window.jQuery);
window.vc || (window.vc = {}), (() => {
    var n = window._,
        a = window.vc;
    a.buildRelevance = function() {
        a.shortcode_relevance = {}, n.each(a.map, function(e) {
            n.isObject(e.as_parent) && n.isString(e.as_parent.only) && (a.shortcode_relevance["parent_only_" + e.base] = e.as_parent.only.replace(/\s/, "").split(",")), n.isObject(e.as_parent) && n.isString(e.as_parent.except) && (a.shortcode_relevance["parent_except_" + e.base] = e.as_parent.except.replace(/\s/, "").split(",")), n.isObject(e.as_child) && n.isString(e.as_child.only) && (a.shortcode_relevance["child_only_" + e.base] = e.as_child.only.replace(/\s/, "").split(",")), n.isObject(e.as_child) && n.isString(e.as_child.except) && (a.shortcode_relevance["child_except_" + e.base] = e.as_child.except.replace(/\s/, "").split(","))
        // START UNCODE EDIT
        //}), a.checkRelevance = function(e, c) {
        }),
        a.shortcode_relevance['parent_except_vc_column_inner'] = (a.shortcode_relevance['parent_except_vc_column_inner'] || []).concat(['vc_row', 'vc_row_inner']),
        a.checkRelevance = function(e, c) {
        // END UNCODE EDIT
           return !(n.isArray(a.shortcode_relevance["parent_only_" + e]) && !n.contains(a.shortcode_relevance["parent_only_" + e], c) || n.isArray(a.shortcode_relevance["parent_except_" + e]) && n.contains(a.shortcode_relevance["parent_except_" + e], c) || n.isArray(a.shortcode_relevance["child_only_" + c]) && !n.contains(a.shortcode_relevance["child_only_" + c], e) || n.isArray(a.shortcode_relevance["child_except_" + c]) && n.contains(a.shortcode_relevance["child_except_" + c], e))
        }
    }
})();
(e => {
    e.vc || (e.vc = {}), e.vc.utils = {
        DOMPurify: e.DOMPurify || {},
        ...
        getMidpointOrder: function(t, e) {
            var o, r = parseFloat(t.get("order")),
                n = t.get("parent_id"),
                n = vc.shortcodes.where({
                    parent_id: n
                }).sort(function(e, t) {
                    return parseFloat(e.get("order")) - parseFloat(t.get("order"))
                });
            return e ? (e = 0, (e = (o = vc.shortcodes.where({
                parent_id: t.get("id")
            })).length && (void 0 === (e = o[o.length - 1].get("order")) || isNaN(e)) ? 0 : e) + 1) : (o = n.findIndex(function(e) {
                return e.id === t.id
            }), (e = n[o + 1]) ? (o = parseFloat(e.get("order")), Math.abs(o - r) < 1e-10 ? (n.forEach(function(e, t) {
                e.set("order", t + 1)
            }), vc.utils.getMidpointOrder(t)) : (r + o) / 2) : r + 1)
        },
        sanitizeString: function(e) {
            return "string" != typeof e ? e : this.DOMPurify.sanitize(e, {
                FORBID_TAGS: ["script", "iframe", "object", "embed", "link", "meta", "style", "base", "form", "input", "textarea", "button", "select", "option", "applet", "frame", "frameset", "noscript", "svg", "math", "template", "a", "img", "audio", "video"],
                FORBID_ATTR: ["onabort", "onblur", "onchange", "onclick", "oncontextmenu", "ondblclick", "onerror", "onfocus", "oninput", "onkeydown", "onkeypress", "onkeyup", "onload", "onloadstart", "onmousedown", "onmouseenter", "onmouseleave", "onmousemove", "onmouseout", "onmouseover", "onmouseup", "onreset", "onscroll", "onselect", "onsubmit", "onunload", "formaction", "src", "srcdoc", "data", "xlink:href", "target"]
            })
        }
    }
})(window);
...
_.isUndefined(window.vc) && (window.vc = {}), window.vc.filters = {
    ...
    function o(t, e) {
        t.on("change keyup setcontent", function() {
            var t = d("#" + e);
            t.length && (t = t.closest(".vc_edit-form-tab")).length && t.trigger("change")
        })
    }
    ...
    window.vc_blurTinyMCEAfterInit = function(t, a) {
        var i;
        t.closest(".vc_ui-panel-window-inner").length && window.tinyMCEPreInit && window.tinyMCEPreInit.mceInit[a] && (window.tinyMCEPreInit.mceInit[a].auto_focus = !1, i = window.tinyMCEPreInit.mceInit[a].setup, window.tinyMCEPreInit.mceInit[a].setup = function(e) {
            i && i(e);
            var n = e.focus;
            e.focus = function() {
                return !1
                ...
                setTimeout(function() {
                    var t = e.getContainer().querySelector("iframe");
                    t && t.blur(), setTimeout(function() {
                        e.focus = n
                    }, 300)
                }, 0), o(e, a)
            })
        ...
        try {
            ...
            }), window.tinyMCEPreInit.mceInit[n].plugins = window.tinyMCEPreInit.mceInit[n].plugins.replace(/,?wpfullscreen/, ""), window.tinyMCEPreInit.mceInit[n].wp_autoresize_on = !1), vc.edit_element_block_view && vc.edit_element_block_view.currentModelParams ? e.val(vc_wpautop(vc.edit_element_block_view.currentModelParams[t.attr("name")] || "")) : e.val(t.val()), quicktags(window.tinyMCEPreInit.qtInit[n]), QTags._buttonsInit(), window.tinymce && (window.vc_blurTinyMCEAfterInit(e, n), window.switchEditors && window.switchEditors.go(n, "tmce"), "4" === tinymce.majorVersion) && (tinymce.execCommand("mceAddEditor", !0, n), setTimeout(function() {
                var t = tinymce.get(n);
                t && o(t, n)
            }, 0)), window.wpActiveEditor = n
        } catch (t) {
    ...
    r.prototype = {
		...
		createControl: function (e) {
            ...
            // }, this), this.$current_control.append('<li class="vc_control-' + .value + '" data-name="' + .value + '">' + .label + n + "</li>")
			// END UNCODE EDIT
        },
        ...
        return this.each(function() {
            ...
            e || t.data("vc_sorted_list", e = new r(this)), "string" == typeof n && e[n]()
        })
    };
    var c = Backbone.View.extend({
        ...
        u = Backbone.View.extend({
            ...
            initialize: function(t) {
                var e, n, a;
                this.$ul = this.$el.find("> .edit_form_line > .vc_param_group-list"), e = d("> .wpb_vc_row", this.$ul), this.initializer = new p({
                    el: this.$el
                    ...
                    e.data("vc-param-group-param", new h({
                        el: d(this),
                        parent: a
            ...
            addNew: function(t) {
                ...
                t.preventDefault(), this.addAllowed() && (void 0 === this.options.param.callbacks || void 0 === this.options.param.callbacks.before_add || "function" != typeof(e = window[this.options.param.callbacks.before_add]) || e()) && ((e = d(JSON.parse(this.$ul.next(".vc_param_group-template").html()))).removeClass("vc_param_group-add_content-wrapper"), e.insertBefore(t.currentTarget), e.show(), this.initializer.setContent(e.find("> .wpb_element_wrapper")), this.initializer.render(), this.items++, e.data("vc-param-group-param", new h({
                    el: e,
                    parent: this
                })), this.afterAdd(e, "new"), window.vc_auto_save && vc.edit_element_block_view.save(), vc.events.trigger("vc-param-group-add-new", t, e, this))
            },
            addAllowed: function() {
        ...
        h = Backbone.View.extend({
            ...
            hookAdminLabel: function(t) {
                for (var e = "", n = "", a = [], i = (s = d(t.currentTarget)).closest(".vc_param_group-wrapper"), t = s.closest(".vc_param").find(".vc_param-group-admin-labels"), o = 0; o < this.adminLabelParams.length; o++) {
                    var s, r = this.adminLabelParams[o],
                        c = (s = i.find("[name=" + r + "]")).closest('[data-vc-ui-element="panel-shortcode-param"]');
                    void 0 !== this.mappedParams[r] && (e = this.mappedParams[r].heading), n = s.is("select") ? s.find("option:selected").text() : !s.is("input:checkbox") || s[0].checked ? s.val() : "", "textarea_raw_html" === (r = {
                        type: c.data("param_type"),
                        param_name: c.data("param_name")
                    }).type || "textarea_ace" === r.type || "textarea_safe" === r.type || "exploded_textarea" === r.type ? n = n || "" : _.isObject(vc.atts[r.type]) && _.isFunction(vc.atts[r.type].render) && (n = vc.atts[r.type].render.call(this, r, n)), "" !== n && a.push("<label>" + _.escape(e) + "</label>: " + _.escape(n))
                }
            ...
            deleteParam: function(t) {
                t && t.preventDefault && t.preventDefault(), !0 === confirm(window.i18nLocale.press_ok_to_delete_section) && (this.options.parent.items--, this.options.parent.afterDelete(), this.$el.remove(), this.unbind(), this.remove(), window.vc_auto_save) && vc.edit_element_block_view.save()
            },
            content: function() {
                return this.$content
            },
            clone: function(t) {
                ...
                t.preventDefault(), this.options.parent.addAllowed() && (t = this.options.parent.$ul.data("settings"), e = this.$content, this.$content = this.$el, n = vc.atts.param_group.parseOne.call(this, t), d.ajax({
                    ...
                    t = t.data || "", t = d(t);
                    t.insertAfter(this.$el), this.$content = e, this.options.parent.initializer.$content = d("> .wpb_element_wrapper", t), this.options.parent.initializer.render(), t.data("vc-param-group-param", new h({
                        el: t,
                        parent: this.options.parent
                    })), this.options.parent.items++, this.options.parent.afterAdd(t, "clone"), window.vc_auto_save && vc.edit_element_block_view.save()
                }))
            },
            toggle: function(t) {
                t.preventDefault();
        ...
        m = (vc.edit_form_callbacks = [], vc.atts = {
            parse: function(t) {
                var e = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]"),
                    n = e.closest('[data-vc-ui-element="panel-shortcode-param"]'),
                    a = _.isUndefined(vc.atts[t.type]) || _.isUndefined(vc.atts[t.type].parse) ? e.length ? e.val() : null : n.data("vcInitParam") ? vc.atts[t.type].parse.call(this, t) : (n = this.model.get("params"), a = e.attr("type"), _.isUndefined(n[t.param_name]) ? e.length && ("checkbox" !== a || e.is(":checked")) ? e.val() : null : n[t.param_name]);
                return void 0 !== e.data("js-function") && void 0 !== window[e.data("js-function")] && (0, window[e.data("js-function")])(this.$el, this, t), a
            },
            parseFrame: function(t) {
                return vc.atts.parse.call(this, t)
            },
            parseText: function(t, e) {
                t = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]"), e = e ? window.vc.utils.sanitizeString(t.val()) : t.val(), t = t.attr("data-value-type");
                try {
            ...
            parse: function(t) {
                return vc.atts.parseText.call(this, t, !0)
            }
        }, vc.atts.textarea = {
            parse: function(t) {
                return vc.atts.parseText.call(this, t, !1)
            }
            ...
            render: function(t, e) {
                return e && e.match(/^#E\-8_/) ? d("<div/>").text(w(e.replace(/^#E\-8_/, ""))).html() : e
            }
        }, vc.atts.checkbox = {
            parse: function(t) {
                var e = [],
            ...
            parse: function(t) {
                t = vc.atts.parseText.call(this, t, !1);
                return base64_encode(rawurlencode(t))
            },
            render: function(t, e) {
                var n;
                return null != e && (n = w(e.trim()), e) ? d("<div/>").text(n).html() : ""
            }
            ...
            init: function(t, e) {
                var n, a = e.find(".textarea_ace_container"),
                    ...
                    e = a.attr("id");
                "undefined" != typeof ace ? ((n = ace.edit(e)).setTheme("ace/theme/chrome"), a = t.mode || "html", n.session.setMode("ace/mode/" + a), n.session.setOption("wrap", "free"), a = "", i.val() && (a = w(i.val())), n.setValue(a, -1), n.clearSelection(), n.getSession().on("change", function() {
                    var t = n.getValue();
                    try {
            ...
            render: function(t, e) {
                ...
                return "external_link" === this.model.getParam("source") && (e = (e = this.model.getParam("custom_srcs")).replace(/^#E\-8_/, ""), e = rawurldecode(base64_decode(e))), _.isEmpty(e) ? (this.$el.removeData("field-" + t.param_name + "-attach-images"), vc.atts.attach_images.updateImages(n, "")) : (g("get_gallery_images", t, e, this.model), vc.atts.attach_images.isParse && d.ajax({
                    type: "POST",
                    url: window.ajaxurl,
                    data: {
            ...
            init: function(t, e) {
                var n = e;
                n.length && ("undefined" != typeof WebFont ? e.data("vc-param-object", new c({
                    el: n
            ...
            extractValues: function(i, t) {
                ...
                return t.each(function() {
                    ...
                    o.$content = d(this), _.each(i.params, function(t) {
                        var e, t = d.extend({}, t),
                            n = t.param_name;
                        t.param_name = i.param_name + "_" + n, ((e = vc.atts.parse.call(o, t)) && e.length || t.save_always) && (a[n] = e)
                    }), e.push(a)
                }), e
            },
            parseOne: function(t) {
            ...
            init: function(t, e) {
                d(".vc_link-build", e).on("click", function(t) {
                    t && t.preventDefault && t.preventDefault(), t && t.stopImmediatePropagation && t.stopImmediatePropagation(), t = d(this).closest(".vc_link"), i = t.find(".wpb_vc_param_value"), o = t.find(".url-label"), s = t.find(".title-label"), t = i.data("json"), r = d("#wp-link-submit"), c = d('<input type="submit" name="vc_link-submit" id="vc_link-submit" class="button-primary" value="Set Link">'), r.hide(), d("#vc_link-submit").remove(), c.insertBefore(r), e = d('<div class="link-target vc-link-nofollow"><label><span></span> <input type="checkbox" id="vc-link-nofollow"> Add nofollow option to link</label></div>'), d("#link-options .vc-link-nofollow").remove(), e.insertAfter(d("#link-options .link-target")), setTimeout(function() {
                        var t = d("#most-recent-results").css("top");
                        d("#most-recent-results").css("top", parseInt(t, 10) + e.height())
                    }, 200), l = !window.wpLink && d.fn.wpdialog && d("#wp-link").length ? {
                        $link: !1,
                        open: function() {
                    ...
                    var i, o, s, r, c, e, l, n = function(t, e) {
                            jQuery(e).addClass("vc-link-wrapper");
                            var a = d("#wp-link-cancel button");
                            c.off("click.vcLink").on("click.vcLink", function(t) {
                                ...
                                return t.target = n[0].checked ? "_blank" : "", t.rel = d("#vc-link-nofollow")[0].checked ? "nofollow" : "", e = _.map(t, function(t, e) {
                                    ...
                                    return t
                                }).join("|"), i.val(e).trigger("change"), i.data("json", t), o.html(t.url + t.target), s.html(t.title), l.close("noReset"), r.show(), c.off("click.vcLink"), c.remove(), a.off("click.vcLinkCancel"), window.wpLink.textarea = "", n.attr("checked", !1), d("#most-recent-results").css("top", ""), d("#vc-link-nofollow").attr("checked", !1), !1
                            }), a.off("click").on("click.vcLinkCancel", function(t) {
                                t && t.preventDefault && t.preventDefault(), t && t.stopImmediatePropagation && t.stopImmediatePropagation(), l.close("noReset"), c.off("click.vcLink"), c.remove(), a.off("click.vcLinkCancel"), window.wpLink.textarea = ""
                            })
                        },
                        a = function(t, e) {
                            jQuery(e).removeClass("vc-link-wrapper"), jQuery(document).off("wplink-open", n), jQuery(document).off("wplink-close", a)
                        };
                    jQuery(document).off("wplink-open", n).on("wplink-open", n), jQuery(document).off("wplink-close", a).on("wplink-close", a), "admin_frontend_editor" === vc_mode ? l.open("vc-hidden-editor") : l.open("content"), _.isString(t.url) && (d("#wp-link-url").length ? d("#wp-link-url") : d("#url-field")).val(t.url), _.isString(t.title) && (d("#wp-link-text").length ? d("#wp-link-text") : d("#link-title-field")).val(t.title), (d("#wp-link-target").length ? d("#wp-link-target") : d("#link-target-checkbox")).prop("checked", !_.isEmpty(t.target)), d("#vc-link-nofollow").length && d("#vc-link-nofollow").prop("checked", !_.isEmpty(t.rel))
                })
            }
        }, vc.atts.sorted_list = {
            init: function(t, e) {
        ...
        v = function() {
            ...
            return '<div class="wpb-gutenberg-controls-container">' + m() + '<button class="vc_gutenberg-modal-update-button">' + t + '</button><button class="wpb-gutenberg-modal-close-button"><i class="vc-composer-icon vc-c-icon-close"></i></button></div>'
        },
        f = function(t) {
            return this.iframe = null, this.options = t || {}, this.value = this.options && this.options.value ? this.options.value : "", this.iframeLoaded = function() {
                var e = !!this.iframe.contentWindow.wp && this.iframe.contentWindow.wp.data,
                    ...
                    l = (e.subscribe(function() {
                        ...
                        !c && t && t.id === n && (c = !0, i.setupEditor(a, {
                            content: r
                        }))
                    }), this.iframe);
                setTimeout(function() {
                    var t, e, n;
                    t = d(t = l).contents(), e = t.find(".edit-post-header-toolbar"), n = v(), d(n).insertAfter(e), t.find(".vc_gutenberg-modal-update-button, .wpb-gutenberg-modal-close-button").on("click", function() {
                        setTimeout(function() {
    ...
    function w(t) {
        var e = "";
        if (t)
            if (window.vc.utils.isBase64(t)) {
                e = base64_decode(t);
                try {
                    e = rawurldecode(e)
                } catch (t) {
                    console.log("Failed to decode:", t.message)
                }
            } else e = t;
        return e
    }
    vc.atts.vc_grid_id = {
        ...
        getValue: function(t) {
            var e, n = t.val();
            return isNaN(n) || "" === n ? (e = parseInt(t.attr("min")), isNaN(e) ? 0 : e) : (n = parseInt(n), e = parseInt(t.attr("min")), (n = (t = parseInt(t.attr("max"))) < n ? t : n) < e ? e : n)
        },
        parse: function(t) {
            var e = window.vc.atts.range,
                t = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]");
            return e.getValue(t)
        },
        init: function(t, e) {
            var n = e.find('[type="number"]'),
                a = e.find('[type="range"]'),
                i = window.vc.atts.range;
            a.on("input", function() {
                n.val(d(this).val())
            }), n.on("input", function() {
                var t = i.getValue(d(this));
                a.val(t)
            })
        }
    }
...
(d => {
    window.vc.HelperPanelViewHeaderFooter = {
        ...
        setButtonMessage: function(t, e) {
            var i, a;
            // START UNCODE EDIT
            // return this.clearButtonMessage = _.bind(this.clearButtonMessage, this), this.buttonMessageTimeout || (void 0 === t && (t = window.i18nLocale.ui_saved), void 0 === e && (e = "success"), i = (a = this.$el.find('[data-vc-ui-element="button-save"]')).html(), a.addClass("vc_ui-button-" + e + " vc_ui-button-undisabled").removeClass("vc_ui-button-action").data("vcCurrentTextHtml", i).data("vcCurrentTextType", e).html(t), _.delay(this.clearButtonMessage, 5e3), this.buttonMessageTimeout = !0), this
            return this.clearButtonMessage = _.bind(this.clearButtonMessage, this), this.buttonMessageTimeout || (void 0 === t && (t = window.i18nLocale.ui_saved), void 0 === e && (e = "success"), i = (a = this.$el.find('[data-vc-ui-element="button-save"]')).html(), a.addClass("vc_ui-button-" + e + " vc_ui-button-undisabled").removeClass("vc_ui-button-action").data("vcCurrentTextHtml", i).data("vcCurrentTextType", e).html(t), _.delay(this.clearButtonMessage, 1e3), this.buttonMessageTimeout = !0), this
            // END UNCODE EDIT
        },
...
window.vc.HelperPanelViewDraggable = {
    ...
    initDraggable: function() {
        var e;
        window.matchMedia("(max-width: 767px )").matches || (e = this).$el.draggable(_.extend({}, this.draggableOptions, {
            start: function() {
                vc.$frame && vc.$frame.length && vc.$frame.css("pointer-events", "none"), e.fixElContainment()
            },
            stop: function() {
                vc.$frame && vc.$frame.length && vc.$frame.css("pointer-events", "auto"), e.fixElContainment()
            }
        }))
    }
};
...
window.vc.HelperEditPanelCache = {
    addEditPanelToCache: function(e, i) {
        // START UNCODE EDIT
        return false;
        // END UNCODE EDIT
        window.vc.editPanelCache = {}, window.vc.editPanelCache.modelId = e, window.vc.editPanelCache.element = i
    },
    isEditPanelCached: function(e) {
        // START UNCODE EDIT
        return false;
        // END UNCODE EDIT
        return !!window.vc.editPanelCache && window.vc.editPanelCache.modelId === e
    },
    ...
    isPanelActiveOrHidden: function() {
        ...
        return false;
        // END UNCODE EDIT
        return !vc.active_panel || "hidden" === getComputedStyle(vc.active_panel.el).visibility
    },
    cacheEditPanel: function() {
        ...
        this.isEditPanelCached(e) || this.isPanelActiveOrHidden() && (vc.closeActivePanel(), vc.edit_element_block_view.render(this.model, !1, !0))
    },
    cacheEditPanelParent: function() {
        // START UNCODE EDIT
        return false;
        // END UNCODE EDIT
        var e = this.parent_view.model.get("id");
        this.isEditPanelCached(e) || this.isPanelActiveOrHidden() && vc.edit_element_block_view.render(this.parent_view.model, !1, !0)
    },
    isCurrentPanelActiveAndNotCached: function() {
        // START UNCODE EDIT
        return false;
        // END UNCODE EDIT
        return !(!vc.active_panel.model || !this.model || this.isEditPanelCached(this.model.get("id")) || vc.active_panel.model.get("id") !== this.model.get("id"))
    }
};
window.vc.HelperEditorElementsAjaxCache = {
    setEditPanelEditorElementAjaxCache: function(e, t) {
        // START UNCODE EDIT
        return false;
        // END UNCODE EDIT
        window.vc.EditElementEditorAjaxCache || (window.vc.EditElementEditorAjaxCache = {}), window.vc.EditElementEditorAjaxCache[e] = t
    },
    removeEditPanelEditorElementAjaxCache: function(e) {
        // START UNCODE EDIT
        return false;
        // END UNCODE EDIT
        window.vc.EditElementEditorAjaxCache && window.vc.EditElementEditorAjaxCache[e] && delete window.vc.EditElementEditorAjaxCache[e]
    },
    isEditPanelEditorElementAjaxCached: function(e) {
        // START UNCODE EDIT
        return false;
        // END UNCODE EDIT
        return window.vc.EditElementEditorAjaxCache && window.vc.EditElementEditorAjaxCache[e]
    },
    getEditPanelEditorElementAjaxCache: function(e) {
        // START UNCODE EDIT
        return false;
        // END UNCODE EDIT
        return window.vc.EditElementEditorAjaxCache[e]
    }
};
(d => {
    window.vc.HelperAddElementEditPanelAjaxCache = {
        cacheTimeoutId: null,
        isAddElementEditPanelAjaxCache: function(e) {
            return window.vc.addElementEditPanelAjaxCache && window.vc.addElementEditPanelAjaxCache[e]
        },
        setAddElementEditPanelAjaxCache: function(t) {
            var e;
            this.isAddElementEditPanelAjaxCache(t) || this.isGridBuilderElement(t) || (window.vc.addElementEditPanelAjaxCache || (window.vc.addElementEditPanelAjaxCache = {}), this.checkAjax(), e = this, window.vc.addElementEditPanelAjaxCache[t] = new Promise(function(a, n) {
                e.ajax = d.ajax({
                    type: "POST",
                    url: window.ajaxurl,
                    data: {
                        ...
                        escape_usage_count: !0,
                        _vcnonce: window.vcAdminNonce
                    }
                }).done(function(e) {
                    !1 === e.success ? (delete window.vc.addElementEditPanelAjaxCache[t], n(new Error(e.data || "Ajax error"))) : (window.vc.addElementEditPanelAjaxCache[t] = e, a(e))
                }).fail(function(e, a) {
                    delete window.vc.addElementEditPanelAjaxCache[t], n(new Error(a || "Ajax canceled"))
                })
            }).catch(function() {}))
        },
        waitAddElementEditPanelAjaxCache: async function(e) {
            if (!window.vc.addElementEditPanelAjaxCache) return !1;
            e = window.vc.addElementEditPanelAjaxCache[e];
            if (!e) return !1;
            if (e instanceof Promise) try {
                await e
            } catch {
                return console.log("Failed to resolve window.vc.addElementEditPanelAjaxCache[shortcodeTag]"), !1
            }
            return !0
        },
        getAddElementEditPanelAjaxCache: function(e) {
            return window.vc.addElementEditPanelAjaxCache[e]
        },
        cacheElement: function(e) {
            var a = this,
                n = d(e.currentTarget);
            this.cacheTimeoutId && clearTimeout(this.cacheTimeoutId), this.cacheTimeoutId = setTimeout(function() {
                a.setAddElementEditPanelAjaxCache(n.data("tag"))
            }, 300)
        },
        isGridBuilderElement: function(e) {
            return e.startsWith("vc_gitem_")
        }
    }
})(window.jQuery);
(t => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.ModalView = Backbone.View.extend({
        ...
        setSize: function() {
            var e = t(window).height() - 150;
            this.$content.css("maxHeight", e), this.trigger("setSize")
        },
        render: function() {
            return t(window).on("resize.ModalView", this.setSize), this.setSize(), vc.closeActivePanel(), this.$el.modal("show"), this
        },
        showMessage: function(e, i) {
            ...
            var s = t('<div class="vc_message type-' + i + '"></div>');
            this.$el.find(".vc_modal-body").prepend(s), s.text(e).fadeIn(), this.message_box_timeout = window.setTimeout(function() {
                s.remove()
            }, 6e3)
        },
        hide: function() {
            t(window).off("resize.ModalView")
        },
        shown: function() {}
    })
})(window.jQuery);
(s => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.PanelView = vc.View.extend({
        ...
        initialize: function() {
            this.clicked = !1, this.$el.removeClass("vc_panel-opacity"), this.$body = s("body"), this.$content = this.$el.find(".vc_panel-body"), _.bindAll(this, "setSize", "fixElContainment", "changeTab", "setTabsSize"), this.on("show", this.setSize, this), this.on("setSize", this.setResize, this), this.on("render", this.resetMinimize, this)
        },
        ...
        fixElContainment: function() {
            // START UNCODE EDIT
            if (s('body').hasClass('vc-sidebar-switch')) {
                this.setSize()
                return;
            }
            // END UNCODE EDIT
            this.$body || (this.$body = s("body"));
        ...
        changeTab: function(e) {
            e && e.preventDefault && e.preventDefault(), e.target && this.$tabs && (e = s(e.target), this.$tabs.find(".vc_active").removeClass("vc_active"), e.parent().addClass("vc_active"), this.$el.find(e.data("target")).addClass("vc_active"), window.setTimeout(this.setTabsSize, 100))
        },
        showMessage: function(e, t) {
            ...
            var i = s('<div class="vc_panel-message type-' + t + '"></div>').appendTo(this.$el.find(".vc_ui-panel-content-container"));
...
(r => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.active_panel = !1, vc.element_start_index = 0, vc.closeActivePanel = function(e) {
        // START UNCODE EDIT
...
(l => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.AddElementBlockView = vc.ModalView.extend({
        ...
        buildFiltering: function() {
            ...
            var e, t, i, n, a = vc.getMapped(t),
                s = !(!t || _.isUndefined(a.as_parent)) && a.as_parent;
            _.isObject(s) ? (n = [], _.isString(s.only) && n.push(_.reduce(s.only.replace(/\s/, "").split(","), function(e, t) {
                return e + (_.isEmpty(e) ? "" : ",") + '[data-element="' + t.trim() + '"]'
            }, "")), _.isString(s.except) && n.push(_.reduce(s.except.replace(/\s/, "").split(","), function(e, t) {
                return e + ':not([data-element="' + t.trim() + '"])'
            }, "")), e += n.join(",")) : i && (e = i), t && !_.isUndefined(a.allowed_container_element) && (a.allowed_container_element ? // START UNCODE EDIT - support array for allowed_container_element in buildFiltering
(_.isString(a.allowed_container_element) && (e += ":not([data-is-container=true]), [data-element=" + a.allowed_container_element + "]"), _.isArray(a.allowed_container_element) && (e += ":not([data-is-container=true]), " + _.map(a.allowed_container_element, function(el) { return "[data-element=" + el.trim() + "]"; }).join(", "))) : e += ":not([data-is-container=true])"), // END UNCODE EDIT
this.$buttons.removeClass("vc_visible").addClass("vc_inappropriate"), l(e, this.$content).removeClass("vc_inappropriate").addClass("vc_visible"), this.hideEmptyFilters()
        },
        ...
        createElement: function(e) {
            ...
            if (!this.preventDoubleExecution) {
                this.preventDoubleExecution = !0, this.do_render = !0, e.preventDefault(), e = l(e.currentTarget).data("tag"), a = {}, !(t = {
                    width: "1/1"
                ...
                var a = {
                    ...
                    params: "vc_row_inner" === e ? a : {}
                };
                for (this.prepend ? (a.order = 0, (s = vc.shortcodes.findWhere({
                        parent_id: this.model.get("id")
                    })) && (a.order = s.get("order") - 1), vc.activity = "prepend") : this.place_after_id && (a.place_after_id = this.place_after_id), this.builder.create(a), n = this.builder.models.length - 1; 0 <= n; n--) this.builder.models[n].get("shortcode");
                ...
                _.isString(s.default_content) && s.default_content.length && (a = this.builder.parse({}, s.default_content, this.builder.last().toJSON()), _.each(a, function(e) {
...
(d => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.AddElementBlockViewBackendEditor = vc.AddElementBlockView.extend({
        render: function(e, t) {
            return this.prepend = !!_.isBoolean(t) && t, this.place_after_id = !!_.isString(t) && t, this.model = !!_.isObject(e) && e, this.$content = this.$el.find('[data-vc-ui-element="panel-add-element-list"]'), this.$buttons = d('[data-vc-ui-element="add-element-button"]', this.$content), vc.AddElementBlockView.__super__.render.call(this)
        },
        createElement: function(e) {
            var t, o, i;
            this.preventDoubleExecution || (this.preventDoubleExecution = !0, e && e.preventDefault && e.preventDefault(), this.do_render = !0, e = d(e.currentTarget).data("tag"), i = !(i = {
                width: "1/1"
            }) === this.model ? (o = vc.shortcodes.create({
                shortcode: "vc_row",
                params: {}
            ...
            }), this.show_settings = !(_.isBoolean(vc.getMapped(e).show_settings_on_create) && !1 === vc.getMapped(e).show_settings_on_create), this.model = i, this.model.get("shortcode"), (t = this).$el.one("hidden.bs.modal", function() {
...
(n => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.PostSettingsPanelView = vc.PanelView.extend({
        events: {
        ...
        save: function() {
            var e;
            this.is_frontend_editor && n("#vc_post-category").length && ((e = n("#vc_post-category")).val() && e.val().length || e.val("1").trigger("change")), this.showMessage(window.i18nLocale.page_settings_updated, "success"), vc.storage = vc.storage || {}, vc.storage.isChanged = !0, this.trigger("save")
        },
        show: function() {
        ...
        isPageSettingsStatusActive: function() {
            var e = new URL(window.location.href).searchParams.get(this.getPageSettingsSlug());
            return e && 0 === n("#vc_post-settings-button").length ? (this.deactivatePageSettingsStatus(), !1) : e
        },
        ...
        updatePost: function(e) {
            var t;
            this.save(), "admin_page" === window.vc_mode ? n("#publish").trigger("click") : (t = n("#vc_post_status"), e = n(e.currentTarget).data("changeStatus"), t.length && (e = n("#vc_post_status").val()), vc.builder.save(e, !0))
        },
        saveDraft: function() {
            this.save(), "admin_page" === window.vc_mode ? n("#save-post").trigger("click") : vc.builder.save("", !0)
        },
        handlePostNameInput: function(e) {
            var t = n(".wpb-post-url--slug");
            t && t.text(n(e.target).val())
        },
        handlePostNameBlur: function(e) {
            var e = n(e.target),
                t = n(".wpb-post-url--slug"),
                i = e.val(),
        ...
        initializeCategorySelect2: function() {
            this.is_frontend_editor && n("#vc_post-category").select2({
                width: "100%",
                closeOnSelect: !1,
                allowHtml: !0,
                dropdownParent: n("#vc_ui-panel-post-settings"),
                templateResult: function(e) {
                    var t, i, a;
                    return e.id ? (t = n('<span class="wpb_select2-option-checkbox"></span>'), i = e.text.replace(/^\s+/, ""), (a = e.text.match(/^\s+/)) && a[0] && t.html(a[0].replace(/\s/g, "&nbsp;")), a = n('<span class="option-text"></span>').text(i), t.append(a), t) : e.text
                },
        ...
        initializeTagsSelect2: function() {
            this.is_frontend_editor && n("#vc_post-tags").select2({
                width: "100%",
                tags: !0,
                tokenSeparators: [","],
        ...
        toggleAddCategory: function() {
            n("#vc_add-new-category").toggle()
        },
        addNewCategory: function(e) {
            e.preventDefault();
            var t, e = n("#vc_new-category").val();
            e && (t = n("#vc_new-category-parent").val(), n.ajax({
                url: window.ajaxurl,
                type: "POST",
                data: {
...
window.jQuery, _.isUndefined(window.vc) && (window.vc = {}), vc.PostSettingsPanelViewBackendEditor = vc.PostSettingsPanelView.extend({
    render: function() {
        return this.trigger("render"), this.trigger("afterRender"), this
    },
    save: function() {
...
(a => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.PostSettingsSeoUIPanelView = vc.PanelView.extend({
        save: function() {
            for (var e = a("#vc_setting-seo-form").serializeArray(), s = {}, o = vc.seo_storage.get("formDataPrevious") || {}, t = 0; t < e.length; t++) {
                var i = e[t].name,
                    n = e[t].value;
                try {
                    JSON.stringify({
                        [i]: n
                    }), s[i] = n, (o && o.hasOwnProperty(i) || "focus-keyphrase" === i) && vc.seo_storage.setResults(n, i, "formDataPrevious")
                } catch (e) {
                    console.warn("Invalid JSON format for field: " + i, e);
                    continue
                }
            }
            a("#vc_post-custom-seo-settings").val(JSON.stringify(s)), this.trigger("save"), window.vc.showMessage(window.i18nLocale.seo_settings_updated, "success")
        }
    })
})(window.jQuery);
(s => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.CustomCodePanelView = vc.PanelView.extend({
        events: {
            "click [data-save=true]": "save",
            "click [data-dismiss=panel]": "hide",
            "click [data-transparent=panel]": "toggleOpacity",
        ...
        is_frontend_editor: !1,
        initialize: function() {
            this.is_frontend_editor = 0 < s("#vc_inline-frame").length, vc.$custom_css = s("#vc_post-custom-css"), vc.$custom_js_header = s("#vc_post-custom-js-header"), vc.$custom_js_footer = s("#vc_post-custom-js-footer"), this.saved_css_data = vc.$custom_css.val(), this.saved_js_header_data = vc.$custom_js_header.val(), this.saved_js_footer_data = vc.$custom_js_footer.val(), window.Vc_postSettingsEditor && this.initEditor(), _.bindAll(this, "setSize", "fixElContainment", "changeTab"), this.on("show", this.setSize, this), this.on("setSize", this.setResize, this), this.on("render", this.resetMinimize, this), this.on("afterRender", function() {
                s(".edit-form-info").initializeTooltips(".vc_column")
            }, this)
        },
        initEditor: function() {
        ...
        render: function() {
            return this.trigger("render"), this.trigger("afterRender"), this.setEditor(), this
        },
        setEditor: function() {
        ...
        changeTab: function(e) {
            ...
            var e = s(e.currentTarget),
                t = e.parent("li");
            t.hasClass("vc_active") || (e.closest('[data-vc-ui-element="panel-tabs-controls"]').find(".vc_active").removeClass("vc_active"), this.$el.find(".vc_panel-tab.vc_active").removeClass("vc_active"), t.addClass("vc_active"), t = e.data("filter"), this.$el.find('.vc_panel-tab[data-filter="' + t + '"]').addClass("vc_active"), this.setSize(), this.trigger("tabChange", this))
        },
        save: function() {
            var e;
            this.setAlertOnDataChange(), this.is_css && (e = this.editor_css.getValue(), vc.$custom_css.val(e), this.saved_css_data = e), this.is_js_header && (e = this.editor_js_header.getValue(), vc.$custom_js_header.val(e), this.saved_js_header_data = e), this.is_js_footer && (e = this.editor_js_footer.getValue(), vc.$custom_js_footer.val(e), this.saved_js_footer_data = e), vc.frame_window && (this.is_css && vc.frame_window.vc_iframe.loadCustomCss(this.saved_css_data), this.is_js_header && vc.frame_window.vc_iframe.loadCustomJsHeader(this.saved_js_header_data), this.is_js_footer) && vc.frame_window.vc_iframe.loadCustomJsFooter(this.saved_js_footer_data), vc.updateSettingsBadge(), window.vc.showMessage(window.i18nLocale.custom_code_updated, "success"), vc.storage = vc.storage || {}, vc.storage.isChanged = !0, this.trigger("save")
        },
        show: function() {
            this.$el.hasClass("vc_active") || (vc.closeActivePanel(), (vc.active_panel = this).$el.addClass("vc_active"), this.draggable || this.initDraggable(), this.fixElContainment(), this.trigger("show"))
        },
        hide: function(e) {
            if (this.isCodeChanged()) {
                if (!confirm(window.i18nLocale.page_settings_confirm)) return;
                this.rollBackChanges()
            }
            vc.PanelView.prototype.hide.call(this, e), vc.updateSettingsBadge(), this.trigger("hide")
        },
        isCodeChanged: function() {
            return this.is_css && this.saved_css_data !== this.editor_css.getValue() || this.is_js_header && this.saved_js_header_data !== this.editor_js_header.getValue() || this.is_js_footer && this.saved_js_footer_data !== this.editor_js_footer.getValue()
        },
        rollBackChanges: function() {
            this.is_css && this.editor_css.setEditor(this.saved_css_data), this.is_js_header && this.editor_js_header.setEditor(this.saved_js_header_data), this.is_js_footer && this.editor_js_footer.setEditor(this.saved_js_footer_data)
        },
        setAlertOnDataChange: function() {
            this.isCodeChanged() && vc.setDataChanged()
        }
    }), vc.CustomCodeUIPanelFrontendEditor = vc.CustomCodePanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).vcExtendUI({
...
window.jQuery, _.isUndefined(window.vc) && (window.vc = {}), vc.CustomCodeViewBackendEditor = vc.CustomCodePanelView.extend({
    render: function() {
        return this.trigger("render"), this.trigger("afterRender"), this.setEditor(), this
    },
    setAlertOnDataChange: function() {
    ...
    save: function() {
        vc.CustomCodeViewBackendEditor.__super__.save.call(this), vc.storage.isChanged = !0
    }
}), vc.CustomCodeUIPanelBackendEditor = vc.CustomCodeViewBackendEditor.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperPanelViewResizable).vcExtendUI(vc.HelperPanelViewDraggable).vcExtendUI({
    uiEvents: {
        setSize: "setEditorSize",
        show: "setEditorSize"
    },
...
(e => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.RowLayoutEditorPanelView = vc.PanelView.extend({
        events: {
            "click [data-dismiss=panel]": "hide",
            "click [data-transparent=panel]": "toggleOpacity",
            "mouseover [data-transparent=panel]": "addOpacity",
        ...
        _builder: !1,
        render: function(t) {
            return this.$input = e("#vc_row-layout"), t && (this.model = t), this.addCurrentLayout(), this.resetMinimize(), vc.column_trig_changes = !0, e(".edit-form-info").initializeTooltips(".vc_ui-panel-content"), this
        },
        builder: function() {
        ...
        addCurrentLayout: function() {
            vc.shortcodes.sort();
            var t = _.map(vc.shortcodes.where({
                parent_id: this.model.get("id")
            }), function(t) {
                t = t.getParam("width");
                return t || "1/1"
        ...
        setLayout: function(t) {
            if (t && t.preventDefault && t.preventDefault(), !this.isBuildComplete()) return !1;
            t = e(t.currentTarget).attr("data-cells"), t = this.model.view.convertRowColumns(t, this.builder());
            this.$input.val(t.join(" + "))
        },
        updateFromInput: function(t) {
            if (t && t.preventDefault && t.preventDefault(), !this.isBuildComplete()) return !1;
            var t = this.$input.val();
            !1 !== (t = this.validateCellsList(t)) ? this.model.view.convertRowColumns(t, this.builder()) : window.alert(window.i18nLocale.wrong_cells_layout)
        },
        validateCellsList: function(t) {
            var i, n, a, o = [],
                t = t.replace(/\s/g, "").split("+");
            return !(1e3 <= _.reduce(_.map(t, function(t) {
                var e;
                return t.match(/^[vc\_]{0,1}span\d{1,2}$/) ? !1 === (e = vc_convert_column_span_size(t)) ? 1e3 : (i = e.split(/\//), o.push(i[0] + "" + i[1]), 12 * parseInt(i[0], 10) / parseInt(i[1], 10)) : !t.match(/^[1-9]|1[0-2]\/[1-9]|1[0-2]$/) || (i = t.split(/\//), n = parseInt(i[0], 10), 5 !== (a = parseInt(i[1], 10)) && 0 != 12 % a) || a < n ? 1e3 : (o.push(n + "" + a), 5 === a ? n : 12 * n / a)
            }), function(t, e) {
                return e += t
            }, 0)) && o.join("_")
        }
...
(t => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.RowLayoutEditorPanelViewBackend = vc.RowLayoutEditorPanelView.extend({
        builder: function() {
        ...
        setLayout: function(e) {
            e && e.preventDefault && e.preventDefault();
            e = t(e.currentTarget).attr("data-cells"), e = this.model.view.convertRowColumns(e);
...
(n => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.TemplatesEditorPanelView = vc.PanelView.extend({
        events: {
            "click [data-dismiss=panel]": "hide",
            "click [data-transparent=panel]": "toggleOpacity",
            "mouseover [data-transparent=panel]": "addOpacity",
        ...
        render: function() {
            this.trigger("render"), this.$name = n("#vc_template-name"), this.$list = n("#vc_template-list");
            var t = n("#vc_tabs-templates");
            return t.find(".vc_edit-form-tab-control").removeClass("vc_active").eq(0).addClass("vc_active"), t.find('[data-vc-ui-element="panel-edit-element-tab"]').removeClass("vc_active").eq(0).addClass("vc_active"), t.find(".vc_edit-form-link").on("click", function(e) {
                e.preventDefault();
                e = n(this);
                t.find(".vc_active").removeClass("vc_active"), e.parent().addClass("vc_active"), n(e.attr("href")).addClass("vc_active")
        ...
        removeTemplate: function(e) {
            ...
            confirm(window.i18nLocale.confirm_deleting_template.replace("{template_name}", t)) && (e.closest('[data-vc-ui-element="template"]').remove(), this.$list.html(window.i18nLocale.loading), n.ajax({
                type: "POST",
                url: window.ajaxurl,
                data: {
        ...
        loadTemplate: function(e) {
            ...
            n.ajax({
                ...
                var t, a;
                _.each(n(e), function(e) {
                    if ("vc_template-data" === e.id) try {
                        a = JSON.parse(e.innerHTML)
                    } catch (e) {
                        window.console && window.console.warn && window.console.warn("loadTemplate json error", e)
                    }
                    "vc_template-html" === e.id && (t = e.innerHTML)
                }), t && a && vc.builder.buildFromTemplate(t, a), this.showMessage(window.i18nLocale.template_added, "success"), vc.closeActivePanel()
            })
        },
        ajaxData: function(e) {
            return {
        ...
        loadDefaultTemplate: function(e) {
            ...
            n.ajax({
                ...
                _.each(n(e), function(e) {
                    ...
                    "vc_template-html" === e.id && (t = e.innerHTML)
                }), t && a && vc.builder.buildFromTemplate(t, a), this.showMessage(window.i18nLocale.template_added, "success")
            })
        },
...
(t => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.TemplatesEditorPanelViewBackendEditor = vc.TemplatesEditorPanelView.extend({
        ajaxData: function(e) {
            return {
...
(r => {
    r.fn.vcAccordion.Constructor.prototype.collapseTemplate = function(o) {
        var e, c, n, t = this.$element,
            a = 0,
            i = this.getContainer().find("[data-vc-preview-handler]").each(function() {
                var t = r(this),
                    o = t.data("vc.accordion");
                void 0 === o && (t.vcAccordion(), o = t.data("vc.accordion")), o && o.setIndex && o.setIndex(a++)
            }).filter(function() {
                var t = r(this).data("vc.accordion");
                return t.getTarget().hasClass(t.activeClass)
            }).filter(function() {
                return t[0] !== this
            });
        i.length && r.fn.vcAccordion.call(i, "hide"), this.isActive() ? r.fn.vcAccordion.call(t, "hide") : (r.fn.vcAccordion.call(t, "show"), e = t.closest(".vc_ui-list-bar-item"), c = t.closest("[data-template_id]"), n = c.closest("[data-vc-ui-element=panel-content]").parent(), setTimeout(function() {
            var t;
            Math.round(c.offset().top - n.offset().top) < 0 && (t = Math.round(c.offset().top - n.offset().top + n.scrollTop() - e.height()), n.animate({
                scrollTop: t
            }, 400)), "function" == typeof o && o(c, n)
        }, 400))
    }
})(window.jQuery);
(l => {
...
(o => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.TemplatesPanelViewBackend = vc.PanelView.extend({
        $name: !1,
        $list: !1,
        ...
        events: o.extend(vc.PanelView.prototype.events, {
        ...
        render: function() {
            return this.$el.css("left", (o(window).width() - this.$el.width()) / 2), this.$name = this.$el.find('[data-js-element="vc-templates-input"]'), this.$name.off("keypress").on("keypress", this.checkInput), this.$list = this.$el.find(".vc_templates-list-my_templates"), vc.TemplatesPanelViewBackend.__super__.render.call(this)
        },
        saveTemplate: function(e) {
            var t, a;
            if (e && e.preventDefault && e.preventDefault(), e = this.$name.val(), !(t = (a = this).getPostContent()).trim().length) return this.showMessage(window.i18nLocale.template_is_empty, "error"), !1;
            t = {
                ...
                vc_inline: !0,
                _vcnonce: window.vcAdminNonce
            }, this.setButtonMessage(void 0, void 0).reloadTemplateList(t, function() {
                a.$name.val("").trigger("change")
            }, function() {
                a.showMessage(window.i18nLocale.template_save_error, "error"), a.clearButtonMessage()
            })
        },
        ...
        removeTemplate: function(e) {
            ...
            var t, a, e = o(e.target).closest("[data-template_id]"),
                i = e.find('[data-vc-ui-element="template-title"]').text();
            confirm(window.i18nLocale.confirm_deleting_template.replace("{template_name}", i)) && (t = e.data("template_id"), a = e.data("template_type"), i = e.data("template_action"), e.remove(), o.ajax({
                type: "POST",
                url: window.ajaxurl,
                data: {
                    action: i || this.delete_template_action,
                    template_id: t,
                    template_type: a,
                    vc_inline: !0,
                    _vcnonce: window.vcAdminNonce
        ...
        reloadTemplateList: function(e, t, a) {
            var i = this;
            o.ajax({
                type: "POST",
                url: window.ajaxurl,
                ...
                i.filter = !1, i.$list || (i.$list = i.$el.find(".vc_templates-list-my_templates")), i.$list.prepend(o(e)), "function" == typeof t && t(e)
            }).fail("function" == typeof a ? a : function() {})
        },
        getPostContent: function() {
        ...
        loadTemplate: function(e) {
            e && e.preventDefault && e.preventDefault(), e && e.stopPropagation && e.stopPropagation();
            e = o(e.target).closest("[data-template_id][data-template_type]");
            o.ajax({
                type: "POST",
                url: this.loadUrl,
                data: {
        ...
        buildTemplatePreview: function(e) {
            e && e.preventDefault && e.preventDefault();
            try {
                var i, n = o(e.currentTarget),
                    l = n.closest("[data-template_id]");
                if (l.hasClass("vc_active") || l.hasClass("vc_loading")) n.vcAccordion("collapseTemplate");
                else {
                    var t = l.find("[data-js-content]"),
                        c = 0 < t.children().length;
                    ...
                    n.vcAccordion("collapseTemplate", function() {
                        var e, t = l.data("template_id"),
                            a = l.data("template_type");
                        t && !c && (e = "?", -1 < window.ajaxurl.indexOf("?") && (e = "&"), i = window.ajaxurl + e + o.param({
                            action: s.templateLoadPreviewAction,
                            template_unique_id: t,
                            template_type: a,
                            vc_inline: !0,
                            post_id: window.vc_post_id,
                            _vcnonce: window.vcAdminNonce
                        }), n.find("i").addClass("vc_ui-wp-spinner"), s.$content.html('<iframe style="width: 100%;" data-vc-template-preview-frame="' + t + '"></iframe>'), (e = s.$content.find("[data-vc-template-preview-frame]")).attr("src", i), l.addClass("vc_loading"), e.on("load", function() {
                            l.removeClass("vc_loading"), n.find("i").removeClass("vc_ui-wp-spinner")
                        }))
                    })
                }
            } catch (e) {
        ...
        showMessage: function(e, t) {
            ...
            var i, n = vc.template('<div class="vc_message_box vc_message_box-standard vc_message_box-rounded vc_color-<%- color %>"><div class="vc_message_box-icon"><i class="fa fa fa-<%- icon %>"></i></div><p><%- text %></p></div>');
            switch (t) {
                case "error":
                    i = o('<div class="' + a + '" data-vc-panel-message>').html(n({
                        color: "danger",
                        icon: "times",
                        text: e
                    }));
        ...
        setPreviewFrameHeight: function(e, t) {
            parseInt(t, 10) < 100 && (t = 100), o('data-vc-template-preview-frame="' + e + '"').height(t)
        }
    }), window.vc.TemplateWindowUIPanelBackendEditor.prototype.events = o.extend(!0, window.vc.TemplateWindowUIPanelBackendEditor.prototype.events, {
        'click [data-vc-ui-element="button-save"]': "save",
        'click [data-vc-ui-element="button-close"]': "hide",
        'touchstart [data-vc-ui-element="button-close"]': "hide",
        'click [data-vc-ui-element="button-minimize"]': "toggleOpacity",
...
(s => {
    _.isUndefined(window.vc) && (window.vc = {}), vc.TemplatesPanelViewFrontend = vc.TemplatesPanelViewBackend.extend({
        ...
        renderTemplate: function(e) {
            ...
            _.each(s(e), function(e) {
                ...
                "vc_template-html" === e.id && (a = e.innerHTML)
            }), a && t && vc.builder.buildFromTemplate(a, t) ? this.showMessage(window.i18nLocale.template_added_with_id, "error") : this.showMessage(window.i18nLocale.template_added, "success"), vc.closeActivePanel()
        }
        ...
        showMessage: function(e, a) {
            ...
            var t, n = vc.template('<div class="vc_message_box vc_message_box-standard vc_message_box-rounded vc_color-<%- color %>"><div class="vc_message_box-icon"><i class="fa fa fa-<%- icon %>"></i></div><p><%- text %></p></div>'),
                i = "vc_col-xs-12 wpb_element_wrapper";
            switch (a) {
                case "error":
                    t = s('<div class="' + i + '" data-vc-panel-message>').html(n({
                        color: "danger",
                        icon: "times",
                        text: e
                    }));
...
(r => {
    window.vc.element_start_index = 0, window.vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperPanelTabs).vcExtendUI(vc.HelperAddElementEditPanelAjaxCache).extend({
        ...
        isOnTeasersTab: function() {
            return 0 < this.$el.find('.vc_active [data-filter=".wpb-teaser-item"]').length
        },
        toggleTeasersVisibility: function(e) {
            r(".wpb-content-layouts-container").toggle(!e), r(".wpb-teasers-wrapper").toggle(e)
        },
        searchInTeasers: function(e) {
            var t = r(".wpb-teasers-wrapper"),
                i = this.$el.find(".vc-panel-no-results-message");
            e ? (e = r('.wpb-teaser-item:containsi("' + e + '")'), r(".wpb-teaser-item").hide(), e.show(), e = 0 < e.length, t.find(".wpb-teasers-description, .wpb-teasers-grid").toggle(e), i.text(window.i18nLocale.no_addons_found).toggle(!e)) : (r(".wpb-teaser-item").show(), t.find(".wpb-teasers-description, .wpb-teasers-grid").show(), i.hide())
        },
        initialize: function() {
        ...
        render: function(e, t) {
            _.isUndefined(vc.ShortcodesBuilder) || (this.builder = new vc.ShortcodesBuilder), this.$el.is(":hidden") && window.vc.closeActivePanel(), (window.vc.active_panel = this).prepend = !!_.isBoolean(t) && t, this.place_after_id = !!_.isString(t) && t, this.model = !!_.isObject(e) && e, this.$content = this.$el.find('[data-vc-ui-element="panel-add-element-list"]'), this.$buttons = r('[data-vc-ui-element="add-element-button"]', this.$content), this.buildFiltering(), this.$el.find('[data-vc-ui-element="panel-tab-control"]').eq(0).click(), this.show(), this.$el.find('[data-vc-ui-element="panel-tabs-controls"]').vcTabsLine("moveTabs");
            t = this.$el.find('[data-filter=".wpb-teaser-item"]');
            return t.length && 0 === r(".wpb-teasers-wrapper .wpb-teaser-item").length && t.parent().hide(), vc.is_mobile || r(this.searchSelector).trigger("focus"), vc.AddElementUIPanelBackendEditor.__super__.render.call(this)
        },
        buildFiltering: function() {
            var e, t, i, n = '[data-vc-ui-element="add-element-button"]',
                a = this._getNotIn(this.model ? this.model.get("shortcode") : "");
            r(this.searchSelector).val(""), this.$content.addClass("vc_filter-all"), this.$content.attr("data-vc-ui-filter", "*"), t = !(!(e = this.model ? this.model.get("shortcode") : "vc_column") || _.isUndefined(vc.getMapped(e).as_parent)) && vc.getMapped(e).as_parent, _.isObject(t) ? (i = [], _.isString(t.only) && i.push(_.reduce(t.only.replace(/\s/, "").split(","), function(e, t) {
                return e + (_.isEmpty(e) ? "" : ",") + '[data-element="' + t.trim() + '"]'
            }, "")), _.isString(t.except) && i.push(_.reduce(t.except.replace(/\s/, "").split(","), function(e, t) {
                return e + ':not([data-element="' + t.trim() + '"])'
            }, "")), n += i.join(",")) : a && (n = a), !1 === e || _.isUndefined(vc.getMapped(e).allowed_container_element) || (!1 === vc.getMapped(e).allowed_container_element ? n += ":not([data-is-container=true])" : // START UNCODE EDIT - support array for allowed_container_element in buildFiltering
(_.isString(vc.getMapped(e).allowed_container_element) && (n += ":not([data-is-container=true]), [data-element=" + vc.getMapped(e).allowed_container_element + "]"), _.isArray(vc.getMapped(e).allowed_container_element) && (n += ":not([data-is-container=true]), " + _.map(vc.getMapped(e).allowed_container_element, function(el) { return "[data-element=" + el.trim() + "]"; }).join(", ")))), // END UNCODE EDIT
this.$buttons.removeClass("vc_visible").addClass("vc_inappropriate"), r(n, this.$content).removeClass("vc_inappropriate").addClass("vc_visible"), this.hideEmptyFilters()
        },
        hideEmptyFilters: function() {
            var t = this;
            this.$el.find('[data-vc-ui-element="panel-add-element-tab"].vc_active').removeClass("vc_active"), this.$el.find('[data-vc-ui-element="panel-add-element-tab"]:first').addClass("vc_active"), this.$el.find("[data-filter]").each(function() {
                ...
                ".wpb-teaser-item" === e ? r(this).parent().toggle(0 < r(".wpb-teasers-wrapper .wpb-teaser-item").length) : r(e + ".vc_visible:not(.vc_inappropriate)", t.$content).length ? r(this).parent().show() : r(this).parent().hide()
            })
        },
        _getNotIn: _.memoize(function(n) {
            return '[data-vc-ui-element="add-element-button"]:not(' + _.reduce(vc.map, function(e, t) {
        ...
        filterElements: function(e) {
            ...
            //     n = r(this.searchSelector).val(),
            //     a = (this.$content.removeClass("vc_filter-all"), t.closest(".vc_ui-tabs-line")),
            //     s = r(".vc-panel-no-results-message");
            // if (a.parent().find('[data-vc-ui-element="panel-add-element-tab"].vc_active').removeClass("vc_active"), t.is("[data-filter]")) {
            //     if (t.parent().addClass("vc_active"), ".wpb-teaser-item" === (a = t.data("filter"))) return this.toggleTeasersVisibility(!0), r(this.searchSelector).val(""), void this.searchInTeasers("");
            //     this.toggleTeasersVisibility(!1), i += a, "*" === a ? this.$content.addClass("vc_filter-all") : this.$content.removeClass("vc_filter-all"), this.$content.attr("data-vc-ui-filter", a.replace(".js-category-", "")), r(this.searchSelector).val("")
            // } else if (n.length) {
            //     if (this.isOnTeasersTab()) return this.toggleTeasersVisibility(!0), void this.searchInTeasers(n);
            //     r(".wpb-content-layouts-container").show(), r(".wpb-teasers-wrapper").hide(), i += ':containsi("' + n + '"):not(".vc_element-deprecated")', this.$content.attr("data-vc-ui-filter", "name:" + n)
            // } else if (!n.length) {
            //     if (this.isOnTeasersTab()) return this.toggleTeasersVisibility(!0), void this.searchInTeasers("");
            //     this.toggleTeasersVisibility(!1), r('[data-vc-ui-element="panel-tab-control"][data-filter="*"]').parent().addClass("vc_active"), this.$content.attr("data-vc-ui-filter", "*").addClass("vc_filter-all")
            // }
            // r(".vc_visible", this.$content).removeClass("vc_visible"), r(i, this.$content).addClass("vc_visible"), n.length && 13 === (e.keyCode || e.which) && 1 === (t = r(".vc_visible:not(.vc_inappropriate)", this.$content)).length && t.find("[data-vc-clickable]").click();
            // var l = !1;
            // this.$content.find(".wpb-content-layouts").each(function() {
            //     var e = r(this);
            //     0 < e.find(".vc_visible").length ? (e.closest(".vc_clearfix").show(), l = !0) : e.closest(".vc_clearfix").hide()
            // }), l || this.isOnTeasersTab() ? this.isOnTeasersTab() || s.hide() : s.text(window.i18nLocale.no_elements_found).show()
            var t = r(e.currentTarget),
                i = '[data-vc-ui-element="add-element-button"]',
                n = r(this.searchSelector).val();
            this.$content.removeClass("vc_filter-all");
            t.closest(".vc_ui-tabs-line").parent().find('[data-vc-ui-element="panel-add-element-tab"].vc_active').removeClass("vc_active"), t.is("[data-filter]") ? (t.parent().addClass("vc_active"), i += t = t.data("filter"), "*" === t ? this.$content.addClass("vc_filter-all") : this.$content.removeClass("vc_filter-all"), this.$content.attr("data-vc-ui-filter", t.replace(".js-category-", "")), r(this.searchSelector).val("")) : n.length ? (i += ':containsi("' + n + '"):not(".vc_element-deprecated")', this.$content.attr("data-vc-ui-filter", "name:" + n)) : (n.length, r('[data-vc-ui-element="panel-tab-control"][data-filter="*"]').parent().addClass("vc_active"), this.$content.attr("data-vc-ui-filter", "*").addClass("vc_filter-all")), r(".vc_visible", this.$content).removeClass("vc_visible"), r(i, this.$content).addClass("vc_visible"), n.length && 13 === (e.keyCode || e.which) && 1 === (t = r(".vc_visible:not(.vc_inappropriate)", this.$content)).length && t.find("[data-vc-clickable]").click();
            var a = !1,
                i = r(".vc-panel-no-results-message");
            this.$content.find(".wpb-content-layouts").each(function() {
                var e = r(this);
        ...
        buildOptions: function(e, t, i, n, a, s, l, r, c) {
            e = {
                shortcode: e
            };
            return t && (e.params = t), i && (e.parent_id = i), void 0 !== l && (e.order = l), r && (e.root_id = r), n && a === s && (e.preset = n), c && (e.is_add_element = !0), e
        },
        elementHandlers: {
            vc_section: function(e, t, i, n) {
                i = e.buildOptions(t, null, null, i, n, t);
                e.model = vc.shortcodes.create(i)
            },
            vc_grid_container: function(e, t, i, n) {
                t = e.buildOptions("vc_grid_container", null, null, i, n, t);
                e.model = vc.shortcodes.create(t);
                for (var a = (parseInt(e.model.getParam("rows")) || 1) * (parseInt(e.model.getParam("columns")) || 1), s = 0; s < a; s++) {
                    var l = {
                        shortcode: "vc_grid_container_item",
                        parent_id: e.model.get("id")
                    };
                    i && "vc_grid_container_item" === n && (l.preset = i), vc.shortcodes.create(l)
                }
            },
            vc_flexbox_container: function(e, t, i, n, a, s, l) {
                a = e.buildOptions("vc_flexbox_container", null, a, i, n, t, s, l);
                e.model = e.createFlexboxContainer(a, i, n)
            },
            vc_row: function(e, t, i, n, a, s, l) {
                var r;
                s = a && "vc_section" !== e.model.get("shortcode") ? (r = e.buildOptions("vc_row_inner", {}, a, null, null, "vc_row_inner", s, l), r = vc.shortcodes.create(r), e.buildOptions("vc_column_inner", {
                    width: "1/1"
                }, r.id, null, null, "vc_column_inner", void 0, r.id)) : (a = e.buildOptions("vc_row", {}, a, null, null, "vc_row", s, l), r = vc.shortcodes.create(a), e.buildOptions("vc_column", {
                    width: "1/1"
                }, r.id, null, null, "vc_column", void 0, r.id)), vc.shortcodes.create(s), e.model = r
            },
            default: function(e, t, i, n, a, s, l) {
                a ? (a = e.buildOptions(t, null, a, i, n, t, s, l, !0), e.model = vc.shortcodes.create(a)) : (s = e.buildOptions("vc_row", {}, null, i, n, "vc_row"), l = vc.shortcodes.create(s), a = e.buildOptions("vc_column", {
                    width: "1/1"
                }, l.id, i, n, "vc_column", void 0, l.id), s = vc.shortcodes.create(a), a = e.buildOptions(t, null, s.id, i, n, t, void 0, l.id, !0), e.model = vc.shortcodes.create(a))
            }
        },
        createElement: function(e) {
            e && e.preventDefault && e.preventDefault();
            var e = r(e.currentTarget),
                t = e.data("tag"),
                e = e.closest("[data-preset]"),
                i = e ? e.data("preset") : void 0,
                e = e ? e.data("element") : void 0,
                n = this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.getNextOrder(),
                a = this.model ? this.model.id : null,
                s = this.model ? this.model.get("root_id") : null;
            !1 === this.model && window.vc.storage.lock();
            (this.elementHandlers[t] || this.elementHandlers.default)(this, t, i, e, a, n, s), this.model && (window.vc.latestAddedElement = this.model);
            i = !(_.isBoolean(vc.getMapped(t).show_settings_on_create) && !1 === vc.getMapped(t).show_settings_on_create);
            this.hide(), i && this.showEditForm()
        },
        getFirstPositionIndex: function() {
        ...
        showEditForm: function() {
            window.vc.edit_element_block_view.render(this.model, !0)
        },
        updateAddElementPopUp: function(e, t, i, n) {
            var a = this.$el.find('[data-element="' + t + '"]:first').clone(!0);
            window.vc_all_presets[e] = n, a.find("[data-vc-shortcode-name]").text(i), a.find(".vc_element-description").text(""), a.attr("data-preset", e), a.addClass("js-category-_my_elements_"), a.insertAfter(this.$el.find('[data-element="' + t + '"]:last')), this.$el.find('[data-filter="js-category-_my_elements_"]').show();
        ...
        createFlexboxContainer: function(e, t, i) {
            e = e || {
                shortcode: "vc_flexbox_container"
            };
            var e = vc.shortcodes.create(e),
                n = {
                    shortcode: "vc_flexbox_container_item",
                    parent_id: e.id,
                    root_id: e.id
                };
            return t && "vc_flexbox_container_item" === i && (n.preset = t), vc.shortcodes.create(n), e
        }
    })
})(window.jQuery);
(r => {
    window.vc.AddElementUIPanelFrontendEditor = vc.AddElementUIPanelBackendEditor.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
        ...
        elementHandlers: {
            vc_section: function(e, t, i, n) {
                i = e.buildOptions(t, null, null, i, n, t);
                e.builder.create(i), e.model = e.builder.last()
            },
            vc_grid_container: function(e, t, i, n, l, r) {
                l = e.buildOptions("vc_grid_container", null, l, i, n, t, r);
                e.createGridContainer(l)
            },
            vc_flexbox_container: function(e, t, i, n, l, r) {
                l = e.buildOptions("vc_flexbox_container", null, l, i, n, t, r);
                e.createFlexboxContainer(l)
            },
            vc_row: function(e, t, i, n, l, r) {
                l && "vc_section" !== e.model.get("shortcode") ? e.createRowOrInner("vc_row_inner", {}, {
                    width: "1/1"
                }, l, r) : e.createRowOrInner("vc_row", {}, {
                    width: "1/1"
                }, l, r)
            },
            default: function(e, t, i, n, l, r) {
                l ? (l = e.buildOptions(t, null, l, i, n, t, r, !0), e.builder.create(l), e.model = e.builder.last()) : e.createRowWithColumnAndElement(t, i, n)
            }
        },
        buildOptions: function(e, t, i, n, l, r, o, d) {
            e = {
                shortcode: e
            };
            return t && (e.params = t), i && (e.parent_id = i), void 0 !== o && (e.order = o), n && l === r && (e.preset = n), d && (e.is_add_element = !0), e
        },
        createRowWithColumnAndElement: function(e, t, i) {
            var n = this.buildOptions("vc_row", {}, null, t, i, "vc_row"),
                n = (this.builder.create(n), this.buildOptions("vc_column", {
                    width: "1/1"
                }, this.builder.lastID(), t, i, "vc_column"));
            this.builder.create(n), "vc_row" !== e && (n = this.buildOptions(e, null, this.builder.lastID(), t, i, e, void 0, !0), this.builder.create(n)), this.model = this.builder.last()
        },
        createRowOrInner: function(e, t, i, n, l) {
            "vc_row" === e ? this.builder.create(this.buildOptions("vc_row", t, n, null, null, "vc_row", l)).create(this.buildOptions("vc_column", i, this.builder.lastID(), null, null, "vc_column")) : this.builder.create(this.buildOptions("vc_row_inner", {}, n, null, null, "vc_row_inner", l)).create(this.buildOptions("vc_column_inner", {
                width: "1/1"
            }, this.builder.lastID(), null, null, "vc_column_inner")), this.model = this.builder.last()
        },
        createElement: function(e) {
            e && e.preventDefault && e.preventDefault();
            var e = r(e.currentTarget),
                ...
                i = e ? e.data("preset") : void 0,
                e = e ? e.data("element") : void 0,
                n = this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.nextOrder(),
                l = this.model ? this.model.id : null;
            this.prepend && (window.vc.activity = "prepend");
            (this.elementHandlers[t] || this.elementHandlers.default)(this, t, i, e, l, n);
            i = vc.getMapped(t), _.isString(i.default_content) && i.default_content.length && (e = this.builder.parse({}, i.default_content, this.builder.last().toJSON()), _.each(e, function(e) {
                e.default_content = !0, this.builder.create(e)
            // START UNCODE EDIT	
            ...
            }, this)), this.model || (this.model = this.builder.last()), window.vc.latestAddedElement = this.model;	
            l = !(_.isBoolean(i.show_settings_on_create) && !1 === i.show_settings_on_create), this.hide(), l && this.showEditForm(), this.builder.render(null, this.model)
                if (("vc_row" === t || "uncode_slider" === t || "vc_tabs" === t || "vc_accordion" === t || "vc_section" === t || "rev_slider" === t || "woocommerce_cart" === t || "woocommerce_checkout" === t || "woocommerce_order_tracking" === t) && r('body').hasClass('vc-sidebar-switch')) {
                this.render()	
            }	
            // END UNCODE EDIT            
        },
        createGridContainer: function(e) {
            this.builder.create(e = e || {
                shortcode: "vc_grid_container"
            });
            for (var t = this.builder.last(), i = (parseInt(t.getParam("rows")) || 1) * (parseInt(t.getParam("columns")) || 1), n = 0; n < i; n++) {
                var l = {
                    shortcode: "vc_grid_container_item",
                    parent_id: t.get("id")
                };
                this.builder.create(l)
            }
            this.model = this.builder.last()
        },
        createFlexboxContainer: function(e) {
            this.builder.create(e = e || {
                shortcode: "vc_flexbox_container"
            });
            e = {
                shortcode: "vc_flexbox_container_item",
                parent_id: this.builder.last().get("id")
            };
            this.builder.create(e), this.model = this.builder.last()
        }
    })
})(window.jQuery);
(l => {
    window.vc.ExtendPresets = {
        ...
        addEvents: function() {
            var t = this.$el.find(".vc_edit-form-tab.vc_active"),
                ...
                i = this;
            l(document).off("beforeMinimize.vc.paramWindow", this.minimizeButtonSelector).on("beforeMinimize.vc.paramWindow", this.minimizeButtonSelector, function() {
                t.find(".vc_ui-prompt-presets .vc_ui-prompt-close").trigger("click")
            }), l(document).off("close.vc.paramWindow", this.closeButtonSelector).on("beforeClose.vc.paramWindow", this.closeButtonSelector, function() {
                t.find(".vc_ui-prompt-presets .vc_ui-prompt-close").trigger("click")
            }), l(document).off("show.vc.accordion", this.settingsButtonSelector).on("show.vc.accordion", this.settingsButtonSelector, function() {
                var t = l(this);
        ...
        saveSettings: function(t, e) {
            ...
            return void 0 === e && (e = !1), this.checkAjax(), this.ajax = l.ajax({
                type: "POST",
                dataType: "json",
                url: window.ajaxurl,
        ...
        fetchSaveSettingsDialog: function(e) {
            ...
            i.find(".vc_ui-prompt-presets").length ? void 0 !== e && e(!1) : (this.checkAjax(), this.ajax = l.ajax({
                type: "POST",
                dataType: "json",
                url: window.ajaxurl,
        ...
        showSaveSettingsDialog: function(t) {
            ...
            this.isSettingsPresetDefault = !!t, this.fetchSaveSettingsDialog(function(t) {
                var n, a, o = r.$el.find(".vc_ui-panel-content-container"),
                    c = o.find(".vc_ui-prompt-presets"),
                    d = c.find(".textfield"),
                    e = (o.find(".vc_ui-prompt.vc_visible").removeClass("vc_visible"), c.find("[data-vc-view-settings-preset]"));
                "undefined" !== window.vc_vendor_settings_presets[r.model.get("shortcode")] ? e.removeAttr("disabled") : e.attr("disabled", "disabled"), c.addClass("vc_visible"), d.trigger("focus"), o.addClass("vc_ui-content-hidden"), t && (n = c.find("#vc_ui-save-preset-btn"), a = 0, c.on("submit", function() {
                    var s = d.val();
                    return r.saveSettings(s, r.isSettingsPresetDefault).done(function(t) {
                        var e = this.getParamsForSettingsPreset(),
                            i = (d.val(""), r.setCustomButtonMessage(n, void 0, void 0, !0), t.title || s);
                        vc.events.trigger("vc:savePreset", t.id, r.model.get("shortcode"), i, e), a = _.delay(function() {
                            c.removeClass("vc_visible"), o.removeClass("vc_ui-content-hidden")
                        }, 5e3)
                    }).fail(function() {
                        r.setCustomButtonMessage(n, window.i18nLocale.ui_danger, "danger", !0)
                    }), !1
                }), c.on("click", ".vc_ui-prompt-close", function() {
                    return r.checkAjax(), c.removeClass("vc_visible"), o.removeClass("vc_ui-content-hidden"), r.clearCustomButtonMessage.call(this, n), a && (window.clearTimeout(a), a = 0), !1
                }), l(".edit-form-info").initializeTooltips())
            })
        },
        ...
        loadSettings: function(e) {
            return this.panelInit = !1, this.checkAjax(), this.ajax = l.ajax({
                type: "POST",
                dataType: "json",
                url: window.ajaxurl,
        ...
        saveAsDefaultSettings: function(t, e) {
            ...
            t ? (this.checkAjax(), this.ajax = l.ajax({
                type: "POST",
                dataType: "json",
                url: window.ajaxurl,
        ...
        restoreDefaultSettings: function() {
            var t = this.model.get("shortcode");
            this.checkAjax(), this.ajax = l.ajax({
                type: "POST",
                dataType: "json",
                url: window.ajaxurl,
        ...
        showViewSettingsList: function() {
            ...
            s.find(".vc_ui-prompt-view-presets:not(.vc_visible)").remove(), s.find(".vc_ui-prompt-view-presets").length || (s.find(".vc_ui-prompt.vc_visible").removeClass("vc_visible"), e = this, t = jQuery('<form class="vc_ui-prompt vc_ui-prompt-view-presets"><div class="vc_ui-prompt-controls"><button type="button" class="vc_general vc_ui-control-button vc_ui-prompt-close"><i class="vc-composer-icon vc-c-icon-close"></i></button></div><div class="vc_ui-prompt-title"><label for="prompt_title" class="wpb_element_label">Elements</label></div><div class="vc_ui-prompt-content"><div class="vc_ui-prompt-column"><div class="vc_ui-template-list vc_ui-list-bar" data-vc-action="collapseAll" style="margin-top: 20px;" data-vc-presets-list-content></div></div></div>'), this.buildsettingsListContent(t), t.appendTo(s), t.addClass("vc_visible"), s.addClass("vc_ui-content-hidden"), i = function() {
                ...
                e.loadSettings(l(t.currentTarget).data("vcLoadSettingsPreset")), i()
            }), t.off("click.vc4").on("click.vc4", "[data-vc-set-default-settings-preset]", function() {
                e.saveAsDefaultSettings(l(this).data("vcSetDefaultSettingsPreset"), function() {
        ...
        reloadSettingsMenuContent: function() {
            var t = this.model.get("shortcode"),
                ...
                i = !1;
            return this.setSettingsMenuContent(""), this.checkAjax(), this.ajax = l.ajax({
                type: "POST",
                dataType: "json",
                url: window.ajaxurl,
        ...
        applySettingsPreset: function(t) {
            return this.currentModelParams = t, vc.events.trigger("presets:apply", this.model, t), this._killEditor(), this.trigger("render"), this.show(), this.checkAjax(), this.ajax = l.ajax({
                type: "POST",
                url: window.ajaxurl,
        ...
        showSaveTemplateDialog: function() {
            ...
            this.fetchSaveTemplateDialog(function(e) {
                ...
                i.find(".vc_ui-prompt.vc_visible").removeClass("vc_visible"), a.addClass("vc_visible"), o.trigger("focus"), i.addClass("vc_ui-content-hidden"), e && (t = 0, n = a.find("#vc_ui-save-templates-btn"), a.on("submit", function() {
                    var e = o.val(),
                        e = (c.$el.find(c.settingsButtonSelector), {
                    ...
                    return vc.templates_panel_view.reloadTemplateList(e, function() {
...
(r => {
    window.vc.EditElementPanelView = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.HelperEditPanelCache).vcExtendUI(vc.HelperEditorElementsAjaxCache).vcExtendUI(vc.HelperAddElementEditPanelAjaxCache).vcExtendUI(vc.ExtendPresets).vcExtendUI(vc.ExtendTemplates).vcExtendUI(vc.HelperPrompts).extend({
        ...
        initialize: function() {
            _.bindAll(this, "setSize", "setTabsSize", "fixElContainment", "hookDependent", "resetAjax", "removeAllPrompts"), this.on("setSize", this.setResize, this), this.on("render", this.resetMinimize, this), this.on("render", this.setTitle, this), this.on("render", this.prepareContentBlock, this), window.vc_auto_save && this.on("afterRender", this.formRender, this), this.on("afterRender", function() {
                r(".edit-form-info").initializeTooltips(), this.reInitJsFunctions()
            }, this)
        },
        ...
        showPanel: function(e) {
            e.css("visibility", "visible"), e.css("opacity", "1")
        },
        hidePanel: function(e) {
            e.css("visibility", "hidden"), e.css("opacity", "0")
        },
        render: function(e, t, n = !1) {
            this.model = e;
            var i = this.model.get("id");
            return n ? (this.addEditPanelToCache(i, this.$el), this.processRender(e, t, !0)) : this.isEditPanelCached(i) ? (this.showPanel(window.vc.editPanelCache.element), void this.removeEditPanelCache()) : (vc.closeActivePanel(), this.processRender(e, t))
        },
        processRender: function(e, t, n = !1) {
            this.model = e, this.currentModelParams = this.model.get("params"), (vc.active_panel = this).resetMinimize(), this.clicked = !1, this.$el.css("height", "auto"), this.$el.css("maxHeight", "75vh"), n ? this.hidePanel(this.$el) : this.showPanel(this.$el), n = this.model.setting("params") || [];
            var i = this.model.get("shortcode");
            return this.$el.attr("data-vc-shortcode", i), this.tabsInit = !1, this.panelInit = !1, this.activeTabIndex = 0, this.requiredParamsInitialized = !1, this.mapped_params = {}, this.dependent_elements = {}, _.each(n, function(e) {
                this.mapped_params[e.param_name] = e
            }, this), this.trigger("render"), this.show(), this.processRenderAjax(i, e, t).then(), this
        },
        processRenderAjax: async function(e, t, n) {
            var i = this.model.get("id");
            t.attributes && t.attributes.is_add_element && await this.waitAddElementEditPanelAjaxCache(e) ? (delete t.attributes.is_add_element, this.buildParamsContent(this.getAddElementEditPanelAjaxCache(e))) : this.isEditPanelEditorElementAjaxCached(i) ? this.buildParamsContent(this.getEditPanelEditorElementAjaxCache(i)) : (this.checkAjax(), this.ajax = r.ajax({
                type: "POST",
                url: window.ajaxurl,
        ...
        prepareContentBlock: function() {
            this.$content = this.$el.find(this.contentSelector).removeClass("vc_with-tabs"), this.$content.empty(), this.$spinner = r('<span class="vc_ui-wp-spinner vc_ui-wp-spinner-lg vc_ui-wp-spinner-dark"></span>'), this.$content.prepend(this.$spinner)
        },
        buildParamsContent: function(e) {
            var t, n, i, a = this.model.get("id"),
                a = (this.setEditPanelEditorElementAjaxCache(a, e), this.getExternalScriptsFromDataHtml(e)),
                s = (e = this.removeExternalScriptsFromDataHtml(e), (t = (e = r(e)).find('[data-vc-ui-element="panel-tabs-controls"]')).find(".vc_edit-form-tab-control:first-child").addClass("vc_active"), n = this.$el.find('[data-vc-ui-element="panel-header-content"]'), (i = e.find('[data-vc-ui-element="panel-edit-element-tab"]')) && i.addClass("visually-hidden"), n && n.addClass("visually-hidden"), this.$content.html(e)),
        ...
        init: function() {
            vc.EditElementPanelView.__super__.init.call(this), this.$el.find('[data-vc-ui-element="panel-header-content"]').removeClass("visually-hidden"), this.initParams(), this.initDependency(), r(".wpb_edit_form_elements .textarea_html").each(function() {
                window.init_textarea_html(r(this))
        ...
        initParams: function() {
            ...
            (e = e.length ? e : this.content()).attr("data-vc-param-initialized") || (r('[data-vc-ui-element="panel-shortcode-param"]', e).each(function() {
                var e, t = r(this);
                t.data("vcInitParam") || (e = t.data("param_settings"), vc.atts.init.call(n, e, t), t.data("vcInitParam", !0))
            }), e.attr("data-vc-param-initialized", !0)), this.requiredParamsInitialized || _.isUndefined(vc.required_params_to_init) || (r('[data-vc-ui-element="panel-shortcode-param"]', this.content()).each(function() {
                var e, t = r(this);
        ...
        initDependency: function() {
            ...
            _.each(this.mapped_params, function(e) {
                var t, n, i;
                _.isObject(e) && _.isObject(e.dependency) && (t = e.dependency, _.isString(e.dependency.element) && (n = r("[name=" + e.dependency.element + "].wpb_vc_param_value", this.$content), i = r("[name= " + e.param_name + "].wpb_vc_param_value", this.$content), _.each(n, function(e) {
                    var e = r(e),
                        t = e.attr("name");
        ...
        hookDependent: function(e) {
            var i, t = r(e.currentTarget),
                n = t.closest(".vc_column"),
                a = this.dependent_elements[t.attr("name")],
                s = t.is(":checkbox") ? _.map(this.$content.find("[name=" + r(e.currentTarget).attr("name") + "].wpb_vc_param_value:checked"), function(e) {
                    return r(e).val()
                }) : t.val(),
                e = this.doCheckTabs;
        ...
        checkTabs: function() {
            ...
            !1 === this.tabsInit && (this.tabsInit = !0, this.$content.hasClass("vc_with-tabs")) && (this.$tabsMenu = this.$content.find(".vc_edit-form-tabs-menu")), this.$tabsMenu && (this.$content.find('[data-vc-ui-element="panel-edit-element-tab"]').each(function(e) {
                ...
                r(this).find('[data-vc-ui-element="panel-shortcode-param"]:not(".vc_dependent-hidden")').length ? t.hasClass("vc_dependent-hidden") && (t.removeClass("vc_dependent-hidden").removeClass("vc_tab-color-animated").addClass("vc_tab-color-animated"), window.setTimeout(function() {
        ...
        save: function(e) {
            if (this.model) {
                ...
                this.removeEditPanelEditorElementAjaxCache(t), vc.saveInProcess = !0;
                e = e && e.target && e.target.classList.contains("textarea_html") || !!(e && e.target && e.target.closest(".vc_ui-panel-footer-container")) && !!(t = e.target.closest(".vc_ui-panel-window-inner")) && (t = r(t).find(".vc_ui-panel-content-container")) && 0 < t.find(".html-active").length;
                if (this.panelInit && this.model) {
                    ...
                    t.model.save({
                        params: a
                    }), t.showMessage(window.sprintf(window.i18nLocale.inline_element_saved, vc.getMapped(n).name), "success"), window.vc_auto_save || window.vc.frame_window || this.hide(), t.trigger("save"), vc.events.trigger("editElementPanel:saved", this.model), vc.saveInProcess = !1
                }
            } else vc.saveInProcess = !1
        },
        show: function() {
        ...
        handleHide: function() {
            // START UNCODE EDIT
            // this.checkAjax(), this.ajax = !1, this.model = null, vc.active_panel = !1, this.currentModelParams = !1, this._killEditor(), this.$el.removeClass("vc_active visually-hidden"), this.$el.find(".vc_properties-list").removeClass("vc_with-tabs").css("margin-top", ""), this.$content.empty(), this.trigger("hide")
            this.checkAjax(), this.ajax = !1, this.model = null, vc.active_panel = !1, this.currentModelParams = !1, this._killEditor(), this.$el.removeClass("vc_active visually-hidden"), this.$el.find(".vc_properties-list").removeClass("vc_with-tabs").css("margin-top", ""), this.$content && this.$content !== false && this.$content.empty && this.$content.empty(), this.trigger("hide")
            // END UNCODE EDIT
        },
        setTitle: function() {
        ...
        _killEditor: function() {
            _.isUndefined(window.tinyMCE) || r("textarea.textarea_html", this.$el).each(function() {
        ...
        show: function() {
            vc.EditElementUIPanel.__super__.show.call(this), r('[data-vc-ui-element="panel-tabs-controls"]', this.$el).remove(), this.$el.css("maxHeight", "75vh")
        },
        tabsMenu: function() {
            var e;
        ...
        showPanelContent: function(e) {
            function t() {
                e.removeClass("visually-hidden"), n.$content.find(".vc_ui-wp-spinner").remove(), n.$content.removeClass("vc_properties-list-init"), n.$content.parent().scrollTop(1).scrollTop(0)
            }
            var n = this;
            0 < e.find(".textarea_html").length ? (n.init(), n.$content.parent().scrollTop(0), setTimeout(t, 300)) : (t(), n.init())
        },
        changeTab: function(e) {
            e && e.preventDefault && e.preventDefault();
            e = r(e.currentTarget);
        ...
        checkTabs: function() {
            ...
            !1 === this.tabsInit && (this.tabsInit = !0, this.$tabsMenu = this.$el.find('[data-vc-ui-element="panel-tabs-controls"]')), this.tabsMenu() && (this.content().find('[data-vc-ui-element="panel-edit-element-tab"]').each(function(e) {
                ...
                var t = n.$tabsMenu.find('[data-tab-index="' + e + '"]');
                // END UNCODE EDIT
                r(this).find('[data-vc-ui-element="panel-shortcode-param"]:not(".vc_dependent-hidden")').length ? t.hasClass("vc_dependent-hidden") && (t.removeClass("vc_dependent-hidden"), window.setTimeout(function() {
                    t.removeClass("vc_tab-color-animated")
                }, 200)) : t.addClass("vc_dependent-hidden")
...
_.isUndefined(window.vc) && (window.vc = {}), _.extend(vc, {
    ...
    setDataChanged: function() {
        var e;
        vc.isLayoutChanging || (vc.undoRedoApi && (e = this, _.defer(function() {
    ...
    vc.map = {}, vc.setFrameSize = function(e) {
        var t = s("#vc_navbar"),
            ...
            vc_navbar_height = s('body').hasClass('vc-sidebar-switch') ? 0 : t.height(),
            n = s(window).height() - vc_navbar_height,
            max_height,
            iframe_top;
    ...
    }), vc.getMergedParams = function(r, c) {
        var d, s = vc.getDefaultsAndDependencyMap(r),
            l = {};
        return c = _.extend({}, s.defaults, c), d = _.extend({}, s.dependencyMap), _.each(c, function(e, t) {
            if ("content" !== t) {
                if (!_.isUndefined(d[t])) {
                    ...
                    var n, o = d[t].element,
                        a = c[o],
                        i = !1;
                    if ("string" == typeof a && (i = c[o].split(",").map(function(e) {
                            return e.trim()
                        }).filter(function(e) {
                            return e
                        })), o = _.isEmpty(a), n = _.omit(d[t], "element"), _.isBoolean(n.not_empty) && !0 === n.not_empty && o || _.isBoolean(n.is_empty) && !0 === n.is_empty && !o || n.value && !_.intersection(_.isArray(n.value) ? n.value : [n.value], _.isArray(a) ? a : [a]).length && i && n.value && !_.intersection(_.isArray(n.value) ? n.value : [n.value], _.isArray(i) ? i : [i]).length || n.value_not_equal_to && _.intersection(_.isArray(n.value_not_equal_to) ? n.value_not_equal_to : [n.value_not_equal_to], _.isArray(a) ? a : [a]).length && i && n.value_not_equal_to && _.intersection(_.isArray(n.value_not_equal_to) ? n.value_not_equal_to : [n.value_not_equal_to], _.isArray(i) ? i : [i]).length || n.value_includes && (!a || "string" == typeof a && !a.includes(n.value_includes))) return void(d[t].failed = !0)
                }
                o = vc.getParamSettings(r, t), (_.isUndefined(o) || !_.isUndefined(s.defaults[t]) && s.defaults[t] !== e || _.isUndefined(s.defaults[t]) && "" !== e || !_.isUndefined(o.save_always) && !0 === o.save_always) && (l[t] = e)
            }
        }), l
    ...
    }), vc.CloneModel = function(t, e, n, o) {
        var a, i, r, c;
        return vc.clone_index /= 10, a = _.isBoolean(o) && !0 === o ? e.get("order") : parseFloat(e.get("order")) + vc.clone_index, i = _.extend({}, e.get("params")), n = {
            shortcode: r = e.get("shortcode"),
            parent_id: n,
            order: a,
            cloned: !0,
            cloned_from: e.toJSON(),
            params: i
        }, vc["cloneMethod_" + r] && (n = vc["cloneMethod_" + r](n, e)), _.isBoolean(o) && !0 === o || (n.place_after_id = e.get("id")), t.create(n), c = t.last(), _.each(vc.shortcodes.where({
            parent_id: e.get("id")
        }), function(e) {
            vc.CloneModel(t, e, c.get("id"), !0)
        }, this), c
    }, vc.getColumnSize = function(e) {
        var t, n = 12 % e;
        return 0 < n && (t = e, _.isNumber(t)) && 1 == t % 2 && e % 3 ? e + "/12" : e / (n = 0 === n ? e : n) + "/" + 12 / n
    }, window.InlineShortcodeView = vc.shortcode_view = Backbone.View.vcExtendUI(vc.HelperEditPanelCache).extend({
        hold_hover_on: !1,
        events: {
            ...
            "mouseenter > .vc_controls .vc_control-btn-edit": "cacheEditPanel",
            ...
            touchstart: "onTouchOrPointer",
            pointerdown: "onTouchOrPointer",
        ...
        render: function() {
            ...
            return this.$el.attr("data-tag", e), this.$el.addClass("vc_" + e), this.addControls(), _.isObject(vc.getMapped(e)) && (_.isBoolean(vc.getMapped(e).isContainer) && !0 === vc.getMapped(e).isContainer || !_.isEmpty(vc.getMapped(e).as_parent)) && this.$el.addClass("vc_container-block"), this.changed(), this
        },
        checkControlsPosition: function() {
            var e, t;
            this.$controls_buttons && (t = this.$el.height(), vc.$frame.height() < t ? (e = s(vc.frame_window).scrollTop(), this.$controls_buttons.offset().top, 40 < (e = e - this.$el.offset().top + vc.$frame.height() / 2) && e < t ? this.$controls_buttons.css("top", e) : t < e ? this.$controls_buttons.css("top", t - 40) : this.$controls_buttons.css("top", 40)) : 80 < t ? this.$controls_buttons.css("top", t / 2) : this.$controls_buttons.css("top", Math.min(40, t / 2)))
        },
        ...
        updated: function() {
            _.each(vc.shortcodes.where({
                ...
                e.view && (e.view.parent_view = this, e.view.parentChanged())
        ...
        addControls: function() {
            var e = this.model.get("shortcode"),
                ...
                o = vc_user_access().shortcodeEdit(e),
                a = vc_user_access().partAccess("dragndrop"),
            ...
            this.$controls = s(i(e).trim()).addClass("vc_controls"), this.$controls.appendTo(this.$el), this.$controls_buttons = this.$controls.find("> :first")
        },
        content: function() {
        ...
        handleControlAction: function(e) {
            return e && e.preventDefault && e.preventDefault(), e && e.stopPropagation && e.stopPropagation(), !this._controlsBlocked
        },
        onTouchOrPointer: function(e) {
            var t;
            "pointerdown" === e.type && e.originalEvent && "touch" !== e.originalEvent.pointerType || this._controlsBlocked || 0 < s(e.target).closest(".vc_controls").length || this.$el.hasClass("vc_hover") || ((t = this)._controlsBlocked = !0, this.cacheEditPanel(), setTimeout(function() {
                t._controlsBlocked = !1
            }, 300))
        },
        edit: function(e) {
            // START UNCODE EDIT
            s(document.body).trigger('edit-block-window')
            // END UNCODE EDIT
            !this.handleControlAction(e) || this.isCurrentPanelActiveAndNotCached() || vc.edit_element_block_view.render(this.model)
        },
        destroy: function(e) {
            this.handleControlAction(e) && (vc.showMessage(window.sprintf(window.i18nLocale.inline_element_deleted, this.model.setting("name"))), this.model.destroy())
            // START UNCODE EDIT
        ...
        update: function(e) {
            this.beforeUpdate(e || this.model), vc.builder.update(e || this.model)
        },
        clone: function(e) {
            if (this.handleControlAction(e)) {
                var t, e = new vc.ShortcodesBuilder;
                if (this.builder && !this.builder.is_build_complete) return !1;
                this.builder = e, t = vc.CloneModel(e, this.model, this.model.get("parent_id")), e.setResultMessage(window.sprintf(window.i18nLocale.inline_element_cloned, t.setting("name"), t.get("id"))), e.render()
            }
        },
        copy: function(e) {
            if (this.handleControlAction(e)) return !(this.builder && !this.builder.is_build_complete) && vc.copyShortcode(this.model)
        },
        paste: function(e) {
            if (this.handleControlAction(e)) {
                e = new vc.ShortcodesBuilder;
                if (this.builder && !this.builder.is_build_complete) return !1;
                this.builder = e, vc.clone_index /= 10, vc.pasteShortcode(this.model, e)
            }
        },
        getParam: function(e) {
        ...
        openTemplatesWindow: function(e) {
            // START UNCODE EDIT
            s(document.body).trigger('open-templates-window')
            // END UNCODE EDIT
        ...
        addTextBlock: function(e) {
            ...
            e && e.preventDefault && e.preventDefault(), e = {}, n = {
                width: "1/1"
            }, o = vc.getDefaults("vc_column_text"), (t = new vc.ShortcodesBuilder).create({
                shortcode: "vc_row",
                params: e
            }).create({
                shortcode: "vc_column",
        ...
        addTitleControls: function() {
            var e = (e = new URLSearchParams(window.location.search).get("post_type")).charAt(0).toUpperCase() + e.slice(1),
                ...
                t = i18nLocale.edit + " " + e,
                n = s('<div class="vc_controls-element vc_controls">'),
                o = s('<div class="vc_controls-title vc_controls-cc">'),
                a = s('<span class="vc_control-btn vc_element-name">'),
                e = s('<span class="vc_btn-content">').text(e),
                t = s('<span class="vc_control-btn vc_control-btn-edit" title="' + t + '">').text(t),
                i = s('<span class="vc_btn-content"></span>'),
                r = s('<i class="vc-composer-icon vc-c-icon-mode_edit"></i>');
            i.append(r), t.append(i), a.append(e), o.append(a), o.append(t), n.append(o), vc.$title.append(n), vc.$title.addClass("wpb-post-title"), t.on("click", function(e) {
                e.preventDefault(), vc.post_settings_view.$el.find('.vc_ui-tabs-line [data-vc-ui-element="panel-tab-control"]:first').trigger("click"), vc.post_settings_view.render().show(), s("#vc_page-title-field").focus()
            })
        },
        ...
        events: {
            ...
            "click #vc_custom-code-button": "openCustomCode",
        ...
        initialize: function() {
            _.bindAll(this, "saveRowOrder", "saveElementOrder", "saveColumnOrder", "saveContainerItemOrder", "saveGridContainerOrder", "resizeWindow"), vc.shortcodes.on("change:params", this.changeParamsEvents, this), vc.events.on("shortcodes:add shortcodes:vc_section", vcAddShortcodeDefaultParams, this), vc.events.on("shortcodes:add", vc.atts.addShortcodeIdParam, this)
        },
        ...
        openCustomCode: function(e) {
            e && e.preventDefault && e.preventDefault(), vc.custom_code_view.render().show()
        },
        ...
        saveRowOrder: function(e, t) {
            _.defer(function() {
                var a, i, r = s(t.item.parent()),
                    c = r.find("> [data-tag=vc_row],> [data-tag=vc_section]"),
                ...
                c.each(function(e) {
                    ...
                    o.is(".droppable") ? (a = {}, i = {
                        ...
                        params: a,
                        order: e
                    }, 0 === e ? vc.activity = "prepend" : e + 1 !== c.length && (t.place_after_id = vc.$page.find("> [data-tag=vc_row]:eq(" + (e - 1) + ")").data("modelId")), d.create(t).create({
                        shortcode: "vc_column",
                        parent_id: d.lastID(),
                        params: i
                    }).render()) : (o = (t = vc.shortcodes.get(o.data("modelId"))).get("parent_id"), n = r.closest(".vc_element").data("modelId") || !1, t.save({
                        order: e,
                        parent_id: n
                    }, {
                        silent: !0
                    }), o !== n && (vc.builder.notifyParent(n), vc.builder.notifyParent(o)))
                }), vc.setDataChanged()
            }, this)
        },
        saveElementOrder: function(e, t) {
            _.defer(function(e, t, n) {
                var a, i;
                _.isNull(n.sender) && (a = n.item.parent(), i = a.find("> [data-model-id]"), a.find("> [data-model-id]").each(function(e) {
                    var t, n = s(this),
                        o = !1;
                    n.is(".droppable") ? (t = vc.shortcodes.get(a.parents(".vc_element[data-tag]:first").data("modelId")), n.remove(), 0 === e ? o = !0 : e + 1 !== i.length && (o = a.find("> [data-tag]:eq(" + (e - 1) + ")").data("modelId")), t && vc.add_element_block_view.render(t, o)) : (n = (o = vc.shortcodes.get(n.data("modelId"))).get("parent_id"), t = a.parents(".vc_element[data-tag]:first").data("modelId"), o.save({
                        order: e,
                        parent_id: t
                    }, {
                        silent: !0
        ...
        saveContainerItemOrder: function(e, t) {
            _.defer(function(e, t, n) {
                var o = n.item.parent();
                o.find("> [data-model-id]").each(function(e) {
                    var t = s(this);
                    t.is(".droppable") ? (t.remove(), vc.add_element_block_view.render(vc.shortcodes.get(o.data("modelId")), "prepend")) : vc.shortcodes.get(t.data("modelId")).save({
                        order: e
                    })
                })
            }, this, e, t), vc.setDataChanged()
        },
        saveGridContainerOrder: function(e, t) {
            _.defer(function() {
                var a = s(t.item.parent()),
                    i = a.find("> [data-tag=vc_grid_container]"),
                    r = new vc.ShortcodesBuilder;
                i.each(function(e) {
                    var t, n, o = s(this);
                    o.is(".droppable") ? (o.remove(), t = {
                        shortcode: "vc_grid_container",
                        params: {},
                        order: e
                    }, 0 === e ? vc.activity = "prepend" : e + 1 !== i.length && (t.place_after_id = vc.$page.find("> [data-tag=vc_grid_container]:eq(" + (e - 1) + ")").data("modelId")), r.create(t).render()) : (o = (t = vc.shortcodes.get(o.data("modelId"))).get("parent_id"), n = a.closest(".vc_element").data("modelId") || !1, t.save({
                        order: e,
                        parent_id: n
                    }, {
                        silent: !0
        ...
        saveFlexboxContainerOrder: function(e, t) {
            _.defer(function() {
                var a = s(t.item.parent()),
                    i = a.find("> [data-tag=vc_flexbox_container]"),
                    r = new vc.ShortcodesBuilder;
                i.each(function(e) {
                    var t, n, o = s(this);
                    o.is(".droppable") ? (o.remove(), t = {
                        ...
                        params: {},
                        order: e
                    }, 0 === e ? vc.activity = "prepend" : e + 1 !== i.length && (t.place_after_id = vc.$page.find("> [data-tag=vc_flexbox_container]:eq(" + (e - 1) + ")").data("modelId")), r.create(t).render()) : (o = (t = vc.shortcodes.get(o.data("modelId"))).get("parent_id"), n = a.closest(".vc_element").data("modelId") || !1, t.save({
                        order: e,
                        parent_id: n
                    }, {
                        silent: !0
...
(t => {
    window.InlineShortcodeView_vc_row = window.InlineShortcodeView.extend({
        ...
        convertRowColumns: function(t, o) {
            var e, n, r, s;
            return !!t && (e = vc.isLayoutChanging, vc.isLayoutChanging = !0, s = [], t = this.convertToWidthsArray(t), vc.layout_change_shortcodes = [], vc.layout_old_columns = vc.shortcodes.where({
                parent_id: this.model.get("id")
                ...
                _.each(vc.layout_change_shortcodes, function(t) {
                    ...
                    t.destroy()
                }), vc.layout_old_columns = [], vc.layout_change_shortcodes = [], vc.isLayoutChanging = e, vc.setDataChanged()
            }), t)
        },
        allowAddControl: function() {
            return "edit" !== vc_user_access().getState("shortcodes")
...
// START UNCODE EDIT - register uncode_flexbox and uncode_flexbox_inner as containers
window.InlineShortcodeView_uncode_flexbox = window.InlineShortcodeViewContainer.extend({});
window.InlineShortcodeView_uncode_flexbox_inner = window.InlineShortcodeViewContainer.extend({});
// END UNCODE EDIT
(e => {
    var r = window.vc || {};
    window.InlineShortcodeView_vc_grid_container = window.InlineShortcodeViewContainer.extend({
        ...
        shortcodeCache: {},
        initialize: function(e) {
            _.bindAll(this, "addElement", "addItem", "calculateGridParams"), window.InlineShortcodeView_vc_grid_container.__super__.initialize.call(this, e), r.events.on("editElementPanel:saved", this.calculateGridParams), r.events.on("shortcodes:paste", this.calculateGridParams), r.events.on("shortcodes:destroy", this.calculateGridParams)
        },
        addControls: function() {
            return this.$controls = e('<div class="no-controls"></div>'), this.$controls.appendTo(this.$el), this
        },
        beforeUpdate: function(e) {
            this.handleGridItems(e)
        },
        handleGridItems: function(e) {
            if (e) {
                var t = e.get("id"),
                    e = e.get("params"),
                    i = (e.rows || 1) * (e.columns || 1),
                    e = this.shortcodeCache[t];
                if (e || (e = r.shortcodes.where({
                        parent_id: t
                    }), this.shortcodeCache[t] = e), this.builder || (this.builder = new r.ShortcodesBuilder), e.length < i) {
                    for (var d = e.length; d < i; d++) this.builder.create({
                        shortcode: this.item_tag,
                        parent_id: t,
                        order: r.shortcodes.nextOrder(),
                        params: {}
                    });
                    this.builder.render(), this.shortcodeCache[t] = r.shortcodes.where({
                        parent_id: t
                    })
                } else e.length > i && (e = e.slice(i), _.each(e, function(e) {
                    e.destroy()
                }), this.shortcodeCache[t] = r.shortcodes.where({
                    parent_id: t
                }))
            }
        },
        addElement: function(e) {
            e && e.preventDefault && e.preventDefault(), this.addItem()
        },
        addItem: function() {
            r.builder.create({
                shortcode: this.item_tag,
        ...
        calculateGridParams: function(e) {
            var t, i, d;
            e.get("shortcode") === this.item_tag && (e = this.model.get("params") || {}, t = this.model.get("id"), d = r.shortcodes.where({
                parent_id: t
            }), i = this.model.getParam("columns") || 1, d = Math.ceil(d.length / i).toString(), e.rows = d, this.model.save({
                params: e
            }, {
                silent: !0
            }), this.model.set("rows", d), r.EditElementPanelCache && r.EditElementPanelCache[t] && delete r.EditElementPanelCache[t], r.active_panel.model) && r.active_panel.model.get("id") === this.model.get("id") && r.edit_element_block_view.render(this.model)
        }
    })
})(window.jQuery);
window.InlineShortcodeView_vc_grid_container_item = window.InlineShortcodeViewContainerWithParent.extend({
    ...
    destroy: function(e) {
        var t = this.model.get("parent_id");
        window.InlineShortcodeView_vc_grid_container_item.__super__.destroy.call(this, e), vc.shortcodes.where({
            parent_id: t
...
(e => {
    ...
    window.InlineShortcodeView_vc_flexbox_container = window.InlineShortcodeViewContainer.extend({
        ...
        shortcodeCache: {},
        initialize: function(e) {
            _.bindAll(this, "addElement", "addItem"), window.InlineShortcodeView_vc_flexbox_container.__super__.initialize.call(this, e)
        },
        addControls: function() {
            return this.$controls = e('<div class="no-controls"></div>'), this.$controls.appendTo(this.$el), this
        },
...
window.InlineShortcodeView_vc_flexbox_container_item = window.InlineShortcodeViewContainerWithParent.extend({
    controls_selector: "#vc_controls-template-vc_container_item",
    destroy: function(e) {
        var t = this.model.get("parent_id");
        window.InlineShortcodeView_vc_flexbox_container_item.__super__.destroy.call(this, e), vc.shortcodes.where({
            parent_id: t
        }).length || vc.shortcodes.get(t).destroy()
    }
});
    ...
    window.vc.cloneMethod_vc_tab = function(t, e) {
        ...
        tabExtraClass: function(model) {
            ...
            if (tab_typography === 'advanced') {
                ...
                tab_extra_class.push( model_parent.getParam("titles_size") === 'custom' && model_parent.getParam("heading_custom_size") !== '' ? 'fontsize-' + model_parent.getParam("uncode_shortcode_id") + '-custom' : '');
...
_.isUndefined(vc) && (window.vc = {}), (n => {
    vc.createPreLoader = function() {
        ...
        }), vc.custom_code_view = new vc.CustomCodeUIPanelFrontendEditor({
            el: "#vc_ui-panel-custom-code"
        ...
        }), vc.removePreLoader(), vc.$frame.get(0).contentWindow.vc_js && vc.$frame.get(0).contentWindow.vc_js(), window.vc && window.vc.bindEditorKeys && window.vc.bindEditorKeys(), n(window).trigger("vc_build"))
...
window.vc || (window.vc = {}), (() => {
    function r(o, e, t) {
        ...
        for (var r = !1, i = (o && (r = o.get("id")), Object.values(e ? vc.ShortcodesBuilder.prototype.parse({}, t, r) : vc.storage.parseContent({}, t, r))), n = 0; n < i.length; n++) {
            var c = i[n];
            if (d(o, c, i)) break;
            s(0 === n && o, c, i, e)
        }
    ...
    var d = function(o, e, t) {
            var r, i, n, c, d, s, a, l, _, h, v, p, S = !0;
            return o ? (e = (o = g(o, e, t)).isModelRow, r = o.isModelColumn, i = o.isModelRowInner, n = o.isModelTtaSection, c = o.isModelTtaToggleSection, d = o.isTopShortcodeRow, s = o.isTopShortcodeRowInner, a = o.isTopShortcodeSection, l = o.containerPreventsShortcode, h = o.isShortcodeTtaContainer, v = o.isTopShortcodeGridItem, p = o.isTopShortcodeFlexboxItem, S = (_ = o.isShortcodeContainer) && (l && !((n || c) && s) || !l && (n || c) && d || e && !(d || a) || i && !s || r && d || o.isModelColumnInner && (s || d) || r && v || o.isModelGridItem && _ && !h || o.isModelGridContainer && !v || r && p || o.isModelFlexboxItem && _ && !h || o.isModelFlexboxContainer && !p) || !_ && (e || i) || (o.shortcodeRejectsAsChild || o.containerRejectsAsParent) && !(a && (o.isModelSection || e)),
            // START UNCODE EDIT - allow uncode_flexbox/uncode_flexbox_inner into column/column_inner, but never vc_row/vc_row_inner nested
            S = S || (!l && !d && !s && (o.isModelColumn || o.isModelColumnInner) && (o.isTopShortcodeUncodeFlexbox || o.isTopShortcodeUncodeFlexboxInner))) : "vc_row" === t[0].shortcode && (S = !1), S
            // END UNCODE EDIT
        },
        s = function(o, e, t, r) {
            var i, n, c, d, s, a, l, _, h = Object.assign({}, e);
            return o && (t = (e = g(o, e, t)).isModelRow, i = e.isModelRowInner, n = e.isModelSection, c = e.isTopShortcodeRow, d = e.isTopShortcodeRowInner, s = e.isTopShortcodeSection, _ = e.isModelContainer, a = e.isModelColumn, l = e.isModelGridContainer, e = e.isModelFlexboxContainer, h.params.tab_id && (h.params.tab_id = Date.now() + "-" + vc_guid()), i && d || t && c || !o.get("parent_id") && !(n && c) && !l && !e ? (r && (h.place_after_id = o.get("id")), h.parent_id = o.get("parent_id")) : _ && !t && (h.parent_id = o.get("id")), _ = t || n || l || e, (t || i) && (c || d) || _ && s || _ ? h.order = vc.utils.getMidpointOrder(o) : a && (h.order = vc.utils.getMidpointOrder(o, !0))), n = r ? (r.create(h), r.last()) : vc.shortcodes.create(h), window.vc.latestAddedElement = vc.shortcodes.get(n.get("id")), n
        },
        g = function(o, e, t) {
            var o = o.get("shortcode"),
                r = vc.map[o].allowed_container_element,
                i = vc.map[o].as_parent && vc.map[o].as_parent.only,
                n = vc.map[t[0].shortcode].as_child && vc.map[t[0].shortcode].as_child.only;
            // START UNCODE EDIT - support array for allowed_container_element and add uncode_flexbox cases
            var containerPreventsShortcode;
            if (!1 === r) {
                containerPreventsShortcode = true;
            } else if (Array.isArray(r)) {
                containerPreventsShortcode = !r.includes(t[0].shortcode);
            } else if ("string" == typeof r) {
                containerPreventsShortcode = !r.includes(t[0].shortcode);
            } else {
                containerPreventsShortcode = false;
            }
            // END UNCODE EDIT
            return {
                isModelRow: "vc_row" === o,
                ...
                containerPreventsShortcode: containerPreventsShortcode,
                // END UNCODE EDIT
                isShortcodeContainer: vc.map[t[0].shortcode].is_container,
                isShortcodeTtaContainer: t[0].shortcode.includes("vc_tta_") && vc.map[t[0].shortcode].is_container,
                shortcodeRejectsAsChild: "string" == typeof n && !n.includes(o),
                containerRejectsAsParent: "string" == typeof i && !i.includes(t[0].shortcode),
                isTopShortcodeGridContainer: "vc_grid_container" === t[0].shortcode,
                isTopShortcodeGridItem: "vc_grid_container_item" === t[0].shortcode,
                isModelGridContainer: "vc_grid_container" === o,
                isModelGridItem: "vc_grid_container_item" === o,
                isTopShortcodeFlexboxContainer: "vc_flexbox_container" === t[0].shortcode,
                isTopShortcodeFlexboxItem: "vc_flexbox_container_item" === t[0].shortcode,
                isModelFlexboxContainer: "vc_flexbox_container" === o,
                isModelFlexboxItem: "vc_flexbox_container_item" === o,
                // START UNCODE EDIT - uncode_flexbox custom containers
                isModelUncodeFlexbox: "uncode_flexbox" === o,
                isModelUncodeFlexboxInner: "uncode_flexbox_inner" === o,
                isTopShortcodeUncodeFlexbox: "uncode_flexbox" === t[0].shortcode,
                isTopShortcodeUncodeFlexboxInner: "uncode_flexbox_inner" === t[0].shortcode
                // END UNCODE EDIT
            }
        }
})();
...
(a => {
    window.vc = window.vc || {};
    var e = /(Mac|iPhone|iPod|iPad)/i.test(window.navigator.userAgent) ? "command" : "ctrl",
        t = [{
            keys: e + "+z",
            handler: "undo",
            description: "Undo"
            ...
            keys: "shift+a",
            handler: "openPanel",
            buttonSelector: "#vc_add-new-element",
            description: "Add element"
        }, {
            keys: "shift+t",
            handler: "openPanel",
            buttonSelector: "#vc_templates-editor-button, #vc-templatera-editor-button",
            description: "Templates"
        }, {
            keys: "shift+s",
            handler: "openPanel",
            buttonSelector: "#vc_post-settings-button",
            description: "Settings"
        }, {
            keys: "shift+c",
            handler: "openPanel",
            buttonSelector: "#vc_custom-code-button",
            description: "Custom code"
        }, {
            keys: "shift+i",
            handler: "openPanel",
            buttonSelector: "#vc_seo-button",
            description: "SEO/Insights"
        }],
        c = {
            undo: function(e) {
                e.preventDefault();
                e = a(".vc_undo-button");
                return e.length && !e.is("[disabled]") && e.trigger("click"), !1
            },
            redo: function(e) {
                e.preventDefault();
                e = a(".vc_redo-button");
            ...
            save: function(e, t) {
                e.preventDefault();
                var n, i, e = a(".vc_ui-panel-window.vc_active");
                return e.length && "vc_ui-panel-post-settings" !== e.attr("id") ? window.vc_auto_save || !(n = (n = e.find('[data-vc-ui-element="button-save"]')).length ? n : e.find('[data-vc-ui-element="button-save-update"]')).length || n.hasClass("vc_ui-disabled") || n.is(":disabled") || n.first().trigger("click") : !(n = t) || e.length && "vc_ui-panel-post-settings" === e.attr("id") ? ((i = (t = a("#vc_ui-panel-post-settings")).find('[data-vc-ui-element="button-save-draft"], [data-vc-ui-element="button-save-pending"]')).length || (i = t.find('[data-vc-ui-element="button-update"], [data-vc-ui-element="button-submit-review"]')), (i = e.length && "vc_ui-panel-post-settings" === e.attr("id") ? i.filter(":visible") : i).length && i.first().trigger("click"), n || a("#wpb-save-post").text(window.i18nLocale.loading)) : (t = a('[id="vc_button-save-draft"]').filter(":visible"), e = a('[id="vc_button-save-as-pending"]').filter(":visible"), i = a('[id="vc_button-update"]').filter(":visible"), t.length ? t.trigger("click") : e.length ? e.trigger("click") : i.length && "publish" !== i.attr("data-change-status") && i.trigger("click")), !1
            },
            preview: function(e, t) {
                e.preventDefault();
                e = a(".vc_ui-panel-window.vc_active");
                if (e.length && "vc_ui-panel-post-settings" === e.attr("id")) {
                    e = e.find("#wpb-settings-preview");
                    if (e.length) return e.trigger("click"), !1
                }
                var e = a(".vc_control-preview");
                return e.length ? e.trigger("click") : t && window.vc && window.vc.post_settings_view && (e = a("#wpb-settings-preview")).length && e.trigger("click"), !1
            },
            viewPage: function(e, t) {
                return e.preventDefault(), t ? (e = a(".vc_back-button")).length && e.attr("href") && window.open(e.attr("href"), "_blank") : (t = a("#sample-permalink a")).length && t.attr("href") && window.open(t.attr("href"), "_blank"), !1
            },
            openPanel: function(e, t, n) {
                return e.preventDefault(), n && n.buttonSelector && (e = a(n.buttonSelector).first()).length && e.trigger("click"), !1
            },
            switchTabs: function(e) {
                e.preventDefault();
                var t, e = a(".vc_ui-panel-window.vc_active");
                return e.length && 1 < (t = (t = e.find('[data-vc-ui-element="panel-tab-control"]:visible')).length ? t : e.find(".vc_panel-tabs-link:visible")).length && ((e = t.filter(function() {
                    return a(this).parent().hasClass("vc_active")
                })).length || (e = t.filter(".vc_active")), e = (t.index(e) + 1) % t.length, t.eq(e).trigger("click")), !1
            },
            closePanel: function(e) {
                e.preventDefault();
                var e = a(".vc_modal.vc_active").last();
                return e.length ? (e.removeClass("vc_active"), (e = e.find('[data-vc-ui-element="button-close"], [data-dismiss="modal"]').first()).length && e.trigger("click")) : a(".vc_ui-panel-window.vc_active").length && vc.closeActivePanel(), !1
            }
        };
    ...
    function i(e) {
        var t;
        n(e.target) && (27 === e.keyCode ? c.closePanel(e) : (e.ctrlKey || e.metaKey) && e.shiftKey && 83 === e.keyCode && (t = window.vc && window.vc.$frame && window.vc.$frame.length, c.save(e, t)))
    }

    function o(e) {
        e = new Mousetrap(e);
        return e.stopCallback = function(e, t) {
            return n(t)
        }, e
    }
    ...
    function r(e, i) {
        t.forEach(function(t) {
            var n = c[t.handler];
            n && e.bind(t.keys, function(e) {
                return n(e, i, t)
            }, t.action)
        })
    }
    vc.bindEditorKeys = function() {
        var e;
        window.wpbData && !1 === window.wpbData.shortcuts_enabled || window.Mousetrap && (window.vc.mousetrapInstances = window.vc.mousetrapInstances || [], a(document).on("keydown.vcshortcuts", i), e = o(document), window.vc.mousetrapInstances.push(e), r(e, e = window.vc && window.vc.$frame && window.vc.$frame.length), e) && ((e = function() {
            var e = window.vc.$frame;
            e && e.length && e[0].contentDocument && (e = o(e[0].contentDocument), window.vc.mousetrapInstances.push(e), r(e, !0))
        })(), window.vc.$frame.on("load", e))
    }
})(window.jQuery);