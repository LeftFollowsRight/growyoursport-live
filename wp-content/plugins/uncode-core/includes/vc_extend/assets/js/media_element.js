(function($) {
	...
	media.view.AttachmentsBrowser = media.view.AttachmentsBrowser.extend({
		createToolbar: function() {
			...
			var mediaLabel = new wp.media.view.Label({
				value: l10n.filter_by_media || 'Filter by media',
				attributes: {
					'for': 'media-attachment-type-filters'
				},
				priority: -80
			});

			var mediaFilter = new tagFilter({
			...
			this.toolbar.set('tags-label', mediaLabel.render());
			this.toolbar.set('tags', mediaFilter.render());
		}
	});
	// ---------------------------------
